export default {
  id: 'metal_brushed_171',
  name: 'Metal Brushed 171',
  category: 'Industrial',
  description: 'High-quality procedural metal brushed variation 171.',
  shader: `vec3 generate() { float d = fract(sin(v_uv.x * 0.1) * u_scale); return mix(u_secondary_color, u_primary_color, d); }`,
  uniforms: [
    { id: 'u_scale', name: 'Scale', type: 'float', min: 1.0, max: 1000.0, default: 95.5 },
