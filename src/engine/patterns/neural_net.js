export default {
  ...
  `,
  uniforms: [
    { id: 'u_scale', name: 'Node Density', type: 'float', min: 2.0, max: 20.0, default: 10.0 },
    { id: 'u_primary_color', name: 'Synapse', type: 'color', default: [0.0, 0.8, 1.0, 1.0] },
    { id: 'u_secondary_color', name: 'Neural Base', type: 'color', default: [0.01, 0.02, 0.05, 1.0] }
  ]
};
