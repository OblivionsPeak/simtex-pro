export default {
  ...
  `,
  uniforms: [
    { id: 'u_scale', name: 'Cell Density', type: 'float', min: 2.0, max: 20.0, default: 10.0 },
    { id: 'u_primary_color', name: 'Foam Body', type: 'color', default: [0.1, 0.1, 0.1, 1.0] },
    { id: 'u_secondary_color', name: 'Pore Shade', type: 'color', default: [0.05, 0.05, 0.05, 1.0] }
  ]
};
