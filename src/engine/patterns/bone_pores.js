export default {
  ...
  `,
  uniforms: [
    { id: 'u_scale', name: 'Porosity Zoom', type: 'float', min: 2.0, max: 20.0, default: 8.0 },
    { id: 'u_primary_color', name: 'Bone White', type: 'color', default: [0.95, 0.95, 0.9, 1.0] },
    { id: 'u_secondary_color', name: 'Pore Void', type: 'color', default: [0.1, 0.05, 0.0, 1.0] }
  ]
};
