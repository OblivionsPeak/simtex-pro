export default {
  ...
  `,
  uniforms: [
    { id: 'u_scale',      type: 'float', default: 14,   min: 4,   max: 30, name: 'Cell Scale' },
    { id: 'u_wall_color', type: 'color', default: [0.78, 0.80, 0.82, 1.0], name: 'Wall Colour' },
    { id: 'u_cell_depth', type: 'float', default: 0.85, min: 0.2, max: 1.0, name: 'Cell Depth' }
  ]
};
