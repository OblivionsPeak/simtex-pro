...
void main() { 
  ...
  `,uniforms:[{id:`u_scale`,name:`Grain Density`,type:`float`,min:50,max:200,default:100},{id:`u_primary_color`,name:`Pencil Lead`,type:`color`,default:[.1,.1,.1,1]},{id:`u_secondary_color`,name:`Paper White`,type:`color`,default:[.95,.95,.92,1]}]},We=s({default:()=>Ge}),Ge={id:`chopped_carbon_artisan`,name:`Chopped Carbon`,category:`Industrial`,description:`Randomly oriented forged carbon fragments mimicking premium high-performance composites.`,shader:`
    float hash(vec2 p) { return fract(sin(dot(p, vec2(127.1, 311.7))) * 43758.5453); }
    vec4 generate() {
      vec2 uv = v_uv * u_scale;
      vec2 i_uv = floor(uv);
  ...
  `,uniforms:[{id:`u_scale`,name:`Fragment Size`,type:`float`,min:2,max:20,default:8},{id:`u_primary_color`,name:`Resin Deep`,type:`color`,default:[.1,.1,.12,1]},{id:`u_secondary_color`,name:`Fiber Flake`,type:`color`,default:[.2,.2,.25,1]}]},Ke=s({default:()=>qe}),qe={id:`circuit_traces_pro`,name:`Circuit Traces`,category:`Technology`,description:`Pro-grade PCB layout with branching traces and circular nodes.`,shader:`
    float hash(vec2 p) { return fract(sin(dot(p, vec2(127.1, 311.7))) * 43758.5453123); }
  ...
  `,uniforms:[{id:`u_scale`,name:`Reef Density`,type:`float`,min:2,max:20,default:8},{id:`u_primary_color`,name:`Polyps`,type:`color`,default:[1,.5,.4,1]},{id:`u_secondary_color`,name:`Ocean Depth`,type:`color`,default:[0,.2,.4,1]}]},Xe=s({default:()=>Ze}),Ze={id:`corduroy_rib_artisan`,name:`Corduroy Rib`,category:`Abstract`,description:`Parallel fuzzy ridges of heavy fabric used in durable workwear.`,shader:`
    vec4 generate() {
      float rib = sin(v_uv.x * 100.0 * u_scale);
      float mask = smoothstep(-0.5, 0.5, rib);
      return mix(u_secondary_color, u_primary_color, mask);
    }
  `,uniforms:[{id:`u_scale`,name:`Rib Frequency`,type:`float`,min:.1,max:2,default:.8},{id:`u_primary_color`,name:`Rib Ridge`,type:`color`,default:[.4,.3,.2,1]},{id:`u_secondary_color`,name:`Rib Valley`,type:`color`,default:[.15,.1,.05,1]}]},Qe=s({default:()=>$e}),$e={id:`corrugated_steel_artisan`,name:`Corrugated Steel`,category:`Industrial`,description:`Wavy metal sheet textures used in industrial construction and containers.`,shader:`
    vec4 generate() {
      float wave = sin(v_uv.x * 30.0 * (1.0 + u_scale));
      float mask = smoothstep(-0.8, 0.8, wave);
      return mix(u_secondary_color, u_primary_color, mask);
    }
  `,uniforms:[{id:`u_scale`,name:`Wave Frequency`,type:`float`,min:.1,max:2,default:1},{id:`u_primary_color`,name:`Highlight`,type:`color`,default:[.7,.75,.8,1]},{id:`u_secondary_color`,name:`Recess`,type:`color`,default:[.15,.15,.2,1]}]},et=s({default:()=>tt}),tt={id:`crocodile_hide_artisan`,name:`Crocodile Hide`,category:`Natural`,description:`Large rectangular blocky scales with organic gap jitter found in reptilian leather.`,shader:`
    vec4 generate() {
      vec2 uv = v_uv * u_scale;
      vec2 gv = fract(uv);
  ...
  `,uniforms:[{id:`u_scale`,name:`Scale Zoom`,type:`float`,min:2,max:15,default:8},{id:`u_primary_color`,name:`Leather Top`,type:`color`,default:[.15,.1,.05,1]},{id:`u_secondary_color`,name:`Scale Gap`,type:`color`,default:[.05,.03,.01,1]}]},nt=s({default:()=>rt}),rt={id:`cyber_grid_pro`,name:`Cyber Grid`,category:`Technology`,description:`Pro-grade data-matrix style grid with secondary interference lines.`,shader:`
    vec4 generate() {
      vec2 g = fract(v_uv * u_scale);
  ...
  `,uniforms:[{id:`u_primary_color`,name:`Circuit Glow`,type:`color`,default:[1,0,.5,1]},{id:`u_secondary_color`,name:`Synthetic Skin`,type:`color`,default:[.05,.05,.06,1]}]},ot=s({default:()=>st}),st={id:`cyber_twill_artisan`,name:`Cyber Twill`,category:`Technology`,description:`Advanced glowing-edge carbon fiber weave for high-performance cybernetic components.`,shader:`
    vec4 generate() {
      vec2 uv = v_uv * u_scale;
      vec2 gv = fract(uv) - 0.5;
  ...
  `,uniforms:[{id:`u_scale`,name:`Wire Density`,type:`float`,min:20,max:200,default:100},{id:`u_primary_color`,name:`Wire Signal`,type:`color`,default:[1,.8,0,1]},{id:`u_secondary_color`,name:`Insulation`,type:`color`,default:[.1,.1,.1,1]}]},ut=s({default:()=>dt}),dt={id:`damask_silk_artisan`,name:`Damask Silk`,category:`Abstract`,description:`Floral symmetrical weave with high-end fabric sheen found in luxury upholstery.`,shader:`
    vec4 generate() {
  ...
  `,uniforms:[{id:`u_scale`,name:`Pattern Density`,type:`float`,min:2,max:15,default:8},{id:`u_primary_color`,name:`Silk Pattern`,type:`color`,default:[.8,.5,.2,1]},{id:`u_secondary_color`,name:`Base Satin`,type:`color`,default:[.4,.2,.1,1]}]},ft=s({default:()=>pt}),pt={id:`data_matrix_artisan`,name:`Data Matrix`,category:`Technology`,description:`Stacked digital data blocks mimicking high-density computer storage and visualization.`,shader:`
    float hash(vec2 p) { return fract(sin(dot(p, vec2(127.1, 311.7))) * 43758.5453); }
    vec4 generate() {
      vec2 uv = v_uv * u_scale;
      vec2 i_uv = floor(uv);
  ...
  `,uniforms:[{id:`u_scale`,name:`Data Density`,type:`float`,min:10,max:100,default:50},{id:`u_primary_color`,name:`Active Bit`,type:`color`,default:[0,1,.5,1]},{id:`u_secondary_color`,name:`Zero Bit`,type:`color`,default:[0,.1,.05,1]}]},mt=s({default:()=>ht}),ht={id:`demon_scales_artisan`,name:`Demon Scales`,category:`Natural`,description:`Overlapping pointed organic scales with depth found in mythical beast armor.`,shader:`
    vec4 generate() {
      vec2 uv = v_uv * u_scale;
      if (mod(floor(uv.y), 2.0) == 0.0) uv.x += 0.5;
      vec2 gv = fract(uv) - 0.5;
  ...
  `,uniforms:[{id:`u_scale`,name:`Scale Size`,type:`float`,min:5,max:30,default:15},{id:`u_primary_color`,name:`Scale Top`,type:`color`,default:[.3,0,0,1]},{id:`u_secondary_color`,name:`Under Scale`,type:`color`,default:[.1,0,0,1]}]},gt=s({default:()=>_t}),_t={id:`denim_weave_artisan`,name:`Denim Fabric`,category:`Abstract`,description:`Iconic indigo-stained twill weave with micro-directional thread noise.`,shader:`
    float hash(vec2 p) { return fract(sin(dot(p, vec2(127.1, 311.7))) * 43758.5453); }
    vec4 generate() {
      vec2 uv = v_uv * u_scale;
  ...
  `,uniforms:[{id:`u_scale`,name:`Twill Zoom`,type:`float`,min:2,max:20,default:8},{id:`u_primary_color`,name:`Fade Blue`,type:`color`,default:[.3,.4,.6,1]},{id:`u_secondary_color`,name:`Indigo Deep`,type:`color`,default:[.1,.15,.3,1]}]},vt=s({default:()=>yt}),yt={id:`desert_dunes_artisan`,name:`Sand Dunes`,category:`Nature`,description:`Wavy ripple-sand patterns mimicking windswept desert landscapes.`,shader:`
    vec4 generate() {
      float ripple = sin(v_uv.x * u_scale + sin(v_uv.y * 10.0));
      float mask = smoothstep(-0.5, 0.5, ripple);
      return mix(u_secondary_color, u_primary_color, mask);
    }
  `,uniforms:[{id:`u_scale`,name:`Dune Frequency`,type:`float`,min:10,max:100,default:40},{id:`u_primary_color`,name:`Sunlit Sand`,type:`color`,default:[.9,.7,.4,1]},{id:`u_secondary_color`,name:`Dune Shadow`,type:`color`,default:[.7,.5,.3,1]}]},bt=s({default:()=>xt}),xt={id:`diamond_plate_pro`,name:`Diamond Plate`,category:`Industrial`,description:`Classic anti-slip safety metal floor texture.`,shader:`
  ...
  `,uniforms:[{id:`u_scale`,name:`Plate Scale`,type:`float`,min:2,max:20,default:8},{id:`u_primary_color`,name:`Diamond Face`,type:`color`,default:[.7,.7,.72,1]},{id:`u_secondary_color`,name:`Plate Base`,type:`color`,default:[.4,.4,.42,1]}]},St=s({default:()=>Ct}),Ct={id:`diamond_quilt_artisan`,name:`Diamond Quilt`,category:`Abstract`,description:`Stitched padded fabric effect with soft surface shading for luxury upholstery.`,shader:`
    vec4 generate() {
      mat2 m = mat2(0.707, -0.707, 0.707, 0.707);
      vec2 uv = m * v_uv * u_scale;
      vec2 gv = fract(uv);
  ...
  `,uniforms:[{id:`u_scale`,name:`Diamond Size`,type:`float`,min:2,max:15,default:8},{id:`u_primary_color`,name:`Padding`,type:`color`,default:[.1,.1,.1,1]},{id:`u_secondary_color`,name:`Stitch Line`,type:`color`,default:[.4,0,0,1]}]},Et=s({default:()=>Dt}),Dt={id:`diatom_shells_artisan`,name:`Diatom Shells`,category:`Natural`,description:`Intricate microscopic silicate shells found in marine plankton formations.`,shader:`
    vec4 generate() {
  ...
  `,uniforms:[{id:`u_scale`,name:`Detail`,type:`float`,min:10,max:100,default:50}]},jt=s({default:()=>Mt}),Mt={id:`digital_camo_v2_artisan`,name:`Ghost Camo`,category:`Racing`,description:`Advanced multi-scale digital camouflage with low-visibility spectral patterns.`,shader:`
    float hash(vec2 p) { return fract(sin(dot(p, vec2(127.1, 311.7))) * 43758.5453); }
    vec4 generate() {
      float n = hash(floor(v_uv * 10.0)) + hash(floor(v_uv * 40.0)) * 0.5;
      return mix(u_secondary_color, u_primary_color, n / 1.5);
    }
  `,uniforms:[{id:`u_primary_color`,name:`Camo High`,type:`color`,default:[.3,.3,.35,1]},{id:`u_secondary_color`,name:`Camo Deep`,type:`color`,default:[.1,.1,.12,1]}]},Nt=s({default:()=>Pt}),Pt={id:`digital_glitch_pro`,name:`Digital Glitch`,category:`Abstract`,description:`Static pixel shift and signal interference simulation.`,shader:`
    float hash(float n) { return fract(sin(n) * 43758.5453); }
    vec4 generate() {
  ...
  `,uniforms:[{id:`u_scale`,name:`Glitch Density`,type:`float`,min:10,max:100,default:40},{id:`u_primary_color`,name:`Signal`,type:`color`,default:[0,1,.3,1]},{id:`u_secondary_color`,name:`Noise`,type:`color`,default:[.05,.05,.08,1]}]},Ft=s({default:()=>It}),It={id:`door_panel_fabric_artisan`,name:`Panel Fabric`,category:`Racing`,description:`Coarse interior textile weave found in lightweight door cards and racing interiors.`,shader:`
    vec4 generate() {
      vec2 uv = v_uv * u_scale;
  ...
  `,uniforms:[{id:`u_scale`,name:`Weave Size`,type:`float`,min:50,max:300,default:150},{id:`u_primary_color`,name:`Fiber Grain`,type:`color`,default:[.3,.3,.35,1]},{id:`u_secondary_color`,name:`Fabric Base`,type:`color`,default:[.15,.15,.2,1]}]},Lt=s({default:()=>Rt}),Rt={id:`dragon_plate_artisan`,name:`Dragon Plate`,category:`Natural`,description:`Thick, overlapping pointed armor-like scales with depth found in mythical creature hide.`,shader:`
    vec4 generate() {
      vec2 uv = v_uv * u_scale;
      if (mod(floor(uv.y), 2.0) == 0.0) uv.x += 0.5;
      vec2 gv = fract(uv) - 0.5;
  ...
  `,uniforms:[{id:`u_scale`,name:`Plate Size`,type:`float`,min:5,max:25,default:12},{id:`u_primary_color`,name:`Plate Top`,type:`color`,default:[.3,0,.1,1]},{id:`u_secondary_color`,name:`Under Rim`,type:`color`,default:[.1,0,0,1]}]},zt=s({default:()=>Bt}),Bt={id:`energy_shield_artisan`,name:`Phase Shield`,category:`Abstract`,description:`Hexagonal-linked energy barrier pattern with high-frequency interference patterns.`,shader:`
    vec4 generate() {
      vec2 uv = v_uv * u_scale;
      if (mod(floor(uv.y), 2.0) == 0.0) uv.x += 0.5;
      vec2 gv = fract(uv) - 0.5;
  ...
  `,uniforms:[{id:`u_scale`,name:`Shield Zoom`,type:`float`,min:10,max:100,default:40},{id:`u_primary_color`,name:`Ion Glow`,type:`color`,default:[0,1,1,1]},{id:`u_secondary_color`,name:`Hardlight Base`,type:`color`,default:[0,.1,.2,1]}]},Vt=s({default:()=>Ht}),Ht={id:`etched_brass_artisan`,name:`Etched Brass`,category:`Industrial`,description:`Victorian-style chemical etching and ornate brass panel patterns.`,shader:`
    vec4 generate() {
      vec2 uv = v_uv * 10.0;
  ...
  `,uniforms:[{id:`u_primary_color`,name:`Brass High`,type:`color`,default:[.8,.6,.2,1]},{id:`u_secondary_color`,name:`Etched Deep`,type:`color`,default:[.4,.3,.1,1]}]},Ut=s({default:()=>Wt}),Wt={id:`exhaust_heat_artisan`,name:`Exhaust Bluing`,category:`Industrial`,description:`Wavy prismatic heat seasoning found on high-temperature titanium and steel exhaust systems.`,shader:`
    float hash(vec2 p) { return fract(sin(dot(p, vec2(127.1, 311.7))) * 43758.5453); }
    float noise(vec2 p) {
      vec2 i = floor(p); vec2 f = fract(p);
      f = f*f*(3.0-2.0*f);
  ...
  `,uniforms:[]},Gt=s({default:()=>Kt}),Kt={id:`expanded_grating_pro`,name:`Expanded Metal`,category:`Industrial`,description:`Heavy industrial walkway grating with diamond-slotted apertures.`,shader:`
    vec4 generate() {
      vec2 uv = v_uv * u_scale;
      vec2 gv = fract(uv) - 0.5;
  ...
  `,uniforms:[{id:`u_scale`,name:`Mesh Density`,type:`float`,min:5,max:50,default:20},{id:`u_primary_color`,name:`Steel Rib`,type:`color`,default:[.3,.3,.33,1]},{id:`u_secondary_color`,name:`Aperture`,type:`color`,default:[0,0,0,1]}]},qt=s({default:()=>Jt}),Jt={id:`fiber_optic_bundle_artisan`,name:`Fiber Bundle`,category:`Technology`,description:`Glowing bundles of light-conducting strands found in high-speed data transmission systems.`,shader:`
    float hash(vec2 p) { return fract(sin(dot(p, vec2(127.1, 311.7))) * 43758.5453); }
    vec4 generate() {
      float y = floor(v_uv.y * u_scale);
      float n = hash(vec2(y, y));
  ...
  `,uniforms:[{id:`u_scale`,name:`Strand Density`,type:`float`,min:20,max:200,default:80},{id:`u_primary_color`,name:`Optic Glow`,type:`color`,default:[.2,1,1,1]},{id:`u_secondary_color`,name:`Dark Cladding`,type:`color`,default:[0,.05,.1,1]}]},Yt=s({default:()=>Xt}),Xt={id:`fingerprint_swirls_artisan`,name:`Fingerprint Swirls`,category:`Natural`,description:`Swirling organic ridge patterns mimicking human dermatoglyphics.`,shader:`
    float hash(vec2 p) { return fract(sin(dot(p, vec2(127.1, 311.7))) * 43758.5453); }
    float noise(vec2 p) {
      vec2 i = floor(p); vec2 f = fract(p);
      f = f*f*(3.0-2.0*f);
  ...
  `,uniforms:[{id:`u_scale`,name:`Ridge Detail`,type:`float`,min:2,max:15,default:5},{id:`u_primary_color`,name:`Ridge`,type:`color`,default:[.1,.1,.12,1]},{id:`u_secondary_color`,name:`Valley`,type:`color`,default:[.95,.9,.85,1]}]},Zt=s({default:()=>Qt}),Qt={id:`fish_scales_artisan`,name:`Fish Scales`,category:`Natural`,description:`Round, thin overlapping semi-circles found in aquatic life and reflective armor.`,shader:`
    vec4 generate() {
      vec2 uv = v_uv * u_scale;
      if (mod(floor(uv.y), 2.0) == 0.0) uv.x += 0.5;
      vec2 gv = fract(uv);
  ...
  `,uniforms:[{id:`u_scale`,name:`Scale Density`,type:`float`,min:5,max:30,default:15},{id:`u_primary_color`,name:`Scale Body`,type:`color`,default:[.4,.6,.7,.8]},{id:`u_secondary_color`,name:`Joint Shadow`,type:`color`,default:[.1,.2,.3,1]}]},$t=s({default:()=>en}),en={id:`fluid_marbling_pro`,name:`Fluid Marbling`,category:`Abstract`,description:`Organic static liquid flow with colorful mineral-like marbling.`,shader:`
    float hash(vec2 p) { return fract(sin(dot(p, vec2(127.1, 311.7))) * 43758.5453); }
    float noise(vec2 p) {
      vec2 i = floor(p); vec2 f = fract(p);
      f = f*f*(3.0-2.0*f);
  ...
  `,uniforms:[{id:`u_scale`,name:`Flow Scale`,type:`float`,min:1,max:10,default:3},{id:`u_primary_color`,name:`Mineral A`,type:`color`,default:[.4,.1,.8,1]},{id:`u_secondary_color`,name:`Mineral B`,type:`color`,default:[.1,.4,.5,1]}]},tn=s({default:()=>nn}),nn={id:`forest_litter_artisan`,name:`Forest Litter`,category:`Natural`,description:`Dense organic debris and varying leaf shapes found on a forest floor.`,shader:`
    float hash(vec2 p) { return fract(sin(dot(p, vec2(127.1, 311.7))) * 43758.5453); }
    vec4 generate() {
      vec2 uv = v_uv * u_scale;
      float n = hash(floor(uv));
  ...
  `,uniforms:[{id:`u_scale`,name:`Debris Density`,type:`float`,min:2,max:20,default:12},{id:`u_primary_color`,name:`Leaf Dust`,type:`color`,default:[.4,.3,.1,1]},{id:`u_secondary_color`,name:`Soil`,type:`color`,default:[.1,.08,.05,1]}]},rn=s({default:()=>an}),an={id:`forged_carbon`,name:`Forged Carbon`,category:`Organic`,description:`Randomized carbon shred pattern used in hypercars.`,shader:`
    float hash(vec2 p) { return fract(sin(dot(p, vec2(127.1, 311.7))) * 43758.5453123); }
    float fbm(vec2 p) {
      float f = 0.0;
      float a = 0.5;
  ...
  `,uniforms:[{id:`u_scale`,name:`Flake Size`,type:`float`,min:1,max:20,default:8},{id:`u_primary_color`,name:`High Carbon`,type:`color`,default:[.15,.15,.15,1]},{id:`u_secondary_color`,name:`Base Carbon`,type:`color`,default:[.05,.05,.05,1]}]},on=s({default:()=>sn}),sn={id:`frost_crystals_artisan`,name:`Frost Crystals`,category:`Natural`,description:`Crystalline window-ice patterns and frost blooms found in extreme cold.`,shader:`
    float hash(vec2 p) { return fract(sin(dot(p, vec2(127.1, 311.7))) * 43758.5453); }
    vec4 generate() {
  ...
  `,uniforms:[{id:`u_primary_color`,name:`Frost`,type:`color`,default:[.9,.95,1,1]},{id:`u_secondary_color`,name:`Glass`,type:`color`,default:[.1,.2,.3,1]}]},cn=s({default:()=>ln}),ln={id:`frozen_lake_artisan`,name:`Ice Fractures`,category:`Nature`,description:`Angular ice cracks and crystalline fractures found in frozen lake and arctic simulation environments.`,shader:`
    vec2 rand2(vec2 p) { return fract(sin(vec2(dot(p, vec2(127.1, 311.7)), dot(p, vec2(269.5, 183.3)))) * 43758.5453); }
    vec4 generate() {
      vec2 uv = v_uv * u_scale;
      vec2 i_uv = floor(uv);
  ...
  `,uniforms:[{id:`u_scale`,name:`Shard Density`,type:`float`,min:2,max:20,default:8},{id:`u_primary_color`,name:`Ice Shard`,type:`color`,default:[.8,.9,1,1]},{id:`u_secondary_color`,name:`Deep Lake`,type:`color`,default:[0,.1,.2,1]}]},un=s({default:()=>dn}),dn={id:`fusion_panel_artisan`,name:`Fusion Plating`,category:`Technology`,description:`Complex geometric panel lines and "greebles" found on high-energy reactor housings.`,shader:`
    float hash(vec2 p) { return fract(sin(dot(p, vec2(127.1, 311.7))) * 43758.5453); }
    vec4 generate() {
      vec2 uv = v_uv * u_scale;
      vec2 i_uv = floor(uv);
  ...
  `,uniforms:[{id:`u_scale`,name:`Panel Detail`,type:`float`,min:2,max:20,default:8},{id:`u_primary_color`,name:`Alloy Surface`,type:`color`,default:[.12,.12,.15,1]},{id:`u_secondary_color`,name:`Panel Joint`,type:`color`,default:[0,0,0,1]}]},fn=s({default:()=>pn}),pn={id:`galvanized_steel_artisan`,name:`Galvanized Steel`,category:`Industrial`,description:`Spangled crystalline industrial coating found in heavy-duty utility equipment.`,shader:`
    vec2 rand2(vec2 p) { return fract(sin(vec2(dot(p, vec2(127.1, 311.7)), dot(p, vec2(269.5, 183.3)))) * 43758.5453); }
    vec4 generate() {
      vec2 uv = v_uv * u_scale;
      vec2 i_uv = floor(uv);
  ...
  `,uniforms:[{id:`u_scale`,name:`Spangle Density`,type:`float`,min:2,max:20,default:8},{id:`u_primary_color`,name:`Zinc High`,type:`color`,default:[.9,.9,.92,1]},{id:`u_secondary_color`,name:`Zinc Deep`,type:`color`,default:[.5,.5,.55,1]}]},mn=s({default:()=>hn}),hn={id:`gauge_cluster_artisan`,name:`Gauge Finish`,category:`Racing`,description:`Concentric circular brushed finish found on high-end analog gauge clusters and trim panels.`,shader:`
    vec4 generate() {
      float d = length(v_uv - 0.5);
  ...
  `,uniforms:[{id:`u_primary_color`,name:`Brushed Rim`,type:`color`,default:[.8,.8,.85,1]},{id:`u_secondary_color`,name:`Brushed Deep`,type:`color`,default:[.5,.5,.55,1]}]},gn=s({default:()=>_n}),_n={id:`glacier_ice_artisan`,name:`Glacier Ice`,category:`Natural`,description:`Crackled crystalline planes with directional depth found in Arctic ice formations.`,shader:`
    float hash(vec2 p) { return fract(sin(dot(p, vec2(127.1, 311.7))) * 43758.5453); }
    vec4 generate() {
      vec2 uv = v_uv * u_scale;
      float n = hash(floor(uv));
  ...
  `,uniforms:[{id:`u_scale`,name:`Shelf Scale`,type:`float`,min:1,max:20,default:5},{id:`u_primary_color`,name:`Clean Ice`,type:`color`,default:[.9,.95,1,.8]},{id:`u_secondary_color`,name:`Deep Freeze`,type:`color`,default:[.1,.3,.5,1]}]},vn=s({default:()=>yn}),yn={id:`glass_shards_artisan`,name:`Glass Shards`,category:`Abstract`,description:`Sharp, non-animated geometric fragmentation mimicking shattered glass.`,shader:`
  ...
  `,uniforms:[{id:`u_scale`,name:`Shard Density`,type:`float`,min:2,max:20,default:8},{id:`u_primary_color`,name:`Glass Highlight`,type:`color`,default:[.8,.9,1,.5]},{id:`u_secondary_color`,name:`Shard Depth`,type:`color`,default:[.1,.2,.4,.8]}]},bn=s({default:()=>xn}),xn={id:`glitch_interference_artisan`,name:`Signal Glitch`,category:`Abstract`,description:`Chaotic horizontal interference and data-stream glitch patterns.`,shader:`
    float hash(float n) { return fract(sin(n) * 43758.5453); }
    vec4 generate() {
  ...
  `,uniforms:[{id:`u_primary_color`,name:`Signal Peak`,type:`color`,default:[0,1,0,1]},{id:`u_secondary_color`,name:`Static Floor`,type:`color`,default:[0,.05,0,1]}]},Sn=s({default:()=>Cn}),Cn={id:`gold_leaf_artisan`,name:`Gold Leaf`,category:`Abstract`,description:`Irregular metallic foil noise and gold leaf textures for premium accents.`,shader:`
    float hash(vec2 p) { return fract(sin(dot(p, vec2(127.1, 311.7))) * 43758.5453); }
    vec4 generate() {
  ...
  `,uniforms:[{id:`u_scale`,name:`Stone Density`,type:`float`,min:5,max:50,default:20},{id:`u_primary_color`,name:`Gravel`,type:`color`,default:[.7,.7,.75,1]},{id:`u_secondary_color`,name:`Dust`,type:`color`,default:[.3,.3,.32,1]}]},On=s({default:()=>kn}),kn={id:`greek_key_artisan`,name:`Greek Key`,category:`Abstract`,description:`Classic ancient geometric meander border patterns found in historic architecture.`,shader:`
    vec4 generate() {
  ...
  `,uniforms:[{id:`u_scale`,name:`Key Rows`,type:`float`,min:2,max:20,default:10},{id:`u_primary_color`,name:`Meander`,type:`color`,default:[.8,.7,.3,1]},{id:`u_secondary_color`,name:`Plinth`,type:`color`,default:[.1,.1,.1,1]}]},An=s({default:()=>jn}),jn={id:`halftone_dots_artisan`,name:`CMYK Halftone`,category:`Abstract`,description:`Professional offset color dots and halftone patterns used in high-end graphic design.`,shader:`
    vec4 generate() {
      vec2 uv = v_uv * u_scale;
      vec2 gv = fract(uv) - 0.5;
      float d = length(gv);
  ...
  `,uniforms:[{id:`u_scale`,name:`Dot Density`,type:`float`,min:10,max:100,default:50},{id:`u_primary_color`,name:`Ink Dot`,type:`color`,default:[0,1,1,1]},{id:`u_secondary_color`,name:`Paper White`,type:`color`,default:[1,1,1,1]}]},Mn=s({default:()=>Nn}),Nn={id:`halftone_pop_artisan`,name:`Halftone Pop-Art`,category:`Abstract`,description:`Classic CMYK-style dot matrix textures found in pop-art and comic books.`,shader:`
    vec4 generate() {
      vec2 uv = v_uv * u_scale;
      vec2 gv = fract(uv) - 0.5;
  ...
  `,uniforms:[{id:`u_scale`,name:`Dot Density`,type:`float`,min:10,max:100,default:40},{id:`u_primary_color`,name:`Dot Color`,type:`color`,default:[0,0,0,1]},{id:`u_secondary_color`,name:`Paper Base`,type:`color`,default:[1,1,.95,1]}]},Pn=s({default:()=>Fn}),Fn={id:`hammered_copper_artisan`,name:`Hammered Copper`,category:`Industrial`,description:`Indented, concave specular surfaces found in artisanal hammered metalwork.`,shader:`
    vec2 rand2(vec2 p) { return fract(sin(vec2(dot(p, vec2(127.1, 311.7)), dot(p, vec2(269.5, 183.3)))) * 43758.5453); }
    vec4 generate() {
      vec2 uv = v_uv * u_scale;
      vec2 i_uv = floor(uv);
  ...
  `,uniforms:[{id:`u_scale`,name:`Dents`,type:`float`,min:2,max:20,default:10},{id:`u_primary_color`,name:`Rim Shine`,type:`color`,default:[.9,.6,.4,1]},{id:`u_secondary_color`,name:`Copper Deep`,type:`color`,default:[.4,.2,.1,1]}]},In=s({default:()=>Ln}),Ln={id:`harlequin_diamond`,name:`Harlequin Diamond`,category:`Geometric`,description:`Classic high-contrast diagonal diamond pattern.`,shader:`
    vec4 generate() {
      // Rotate 45 degrees
      float a = 0.785398;
  ...
  `,uniforms:[{id:`u_scale`,name:`Density`,type:`float`,min:2,max:50,default:12},{id:`u_primary_color`,name:`Color A`,type:`color`,default:[1,.1,.1,1]},{id:`u_secondary_color`,name:`Color B`,type:`color`,default:[.1,.1,.1,1]}]},Rn=s({default:()=>zn}),zn={id:`headliner_mesh_artisan`,name:`Headliner Mesh`,category:`Racing`,description:`Breathable ceiling textile with hexagonal micro-pores found in modern automotive interiors.`,shader:`
    vec4 generate() {
      vec2 uv = v_uv * u_scale;
      if (mod(floor(uv.y), 2.0) == 0.0) uv.x += 0.5;
      vec2 gv = fract(uv) - 0.5;
  ...
  `,uniforms:[{id:`u_scale`,name:`Weave Size`,type:`float`,min:2,max:100,default:20},{id:`u_primary_color`,name:`Primary Weave`,type:`color`,default:[.1,.1,.1,1]},{id:`u_secondary_color`,name:`Secondary Weave`,type:`color`,default:[.05,.05,.05,1]}]},Hn=s({default:()=>Un}),Un={id:`hex_mesh_pro`,name:`Aerodynamic Hex`,category:`Technology`,description:`Technical high-airflow hexagonal mesh grid.`,shader:`
  ...
  `,uniforms:[{id:`u_scale`,name:`Density`,type:`float`,min:10,max:100,default:40},{id:`u_primary_color`,name:`Mesh`,type:`color`,default:[.35,.35,.4,1]},{id:`u_secondary_color`,name:`Void`,type:`color`,default:[.02,.02,.02,1]}]},Wn=s({default:()=>Gn}),Gn={id:`holographic_glitch_artisan`,name:`Hologlitch`,category:`Abstract`,description:`Chromatic offset stripes and holographic artifacts mimicking digital interference.`,shader:`
    float hash(float n) { return fract(sin(n) * 43758.5453); }
    vec4 generate() {
  ...
  `,uniforms:[{id:`u_primary_color`,name:`Cyan Beam`,type:`color`,default:[0,1,1,1]},{id:`u_secondary_color`,name:`Magenta Blur`,type:`color`,default:[1,0,1,1]}]},Kn=s({default:()=>qn}),qn={id:`honeycomb_bio`,name:`HoneyComb Bio`,category:`Natural`,description:`Precise hexagonal organic cell wall structure.`,shader:`
    float hexDist(vec2 p) {
      p = abs(p);
      float c = dot(p, normalize(vec2(1, 1.73)));
      c = max(c, p.x);
  ...
  `,uniforms:[{id:`u_scale`,name:`Pattern Size`,type:`float`,min:5,max:100,default:40},{id:`u_primary_color`,name:`Primary Thread`,type:`color`,default:[1,1,1,1]},{id:`u_secondary_color`,name:`Secondary Thread`,type:`color`,default:[.05,.05,.05,1]}]},Xn=s({default:()=>Zn}),Zn={id:`hunting_camo_forest`,name:`Forest Hunting Camo`,category:`Racing`,description:`Pro-grade wilderness camouflage with organic branch and leaf shapes.`,shader:`
    float hash(vec2 p) { return fract(sin(dot(p, vec2(127.1, 311.7))) * 43758.5453123); }
    float noise(vec2 p) {
      vec2 i = floor(p);
      vec2 f = fract(p);
  ...
  `,uniforms:[{id:`u_scale`,name:`Detail Density`,type:`float`,min:1,max:10,default:3.5}]},Qn=s({default:()=>$n}),$n={id:`impasto_paint_artisan`,name:`Impasto Paint`,category:`Abstract`,description:`Thick, textured brush strokes and heavy oil paint impasto effects.`,shader:`
    float hash(vec2 p) { return fract(sin(dot(p, vec2(127.1, 311.7))) * 43758.5453); }
    float noise(vec2 p) {
      vec2 i = floor(p); vec2 f = fract(p);
      f = f*f*(3.0-2.0*f);
  ...
  `,uniforms:[{id:`u_primary_color`,name:`Paint Peak`,type:`color`,default:[.8,.1,.1,1]},{id:`u_secondary_color`,name:`Canvas Base`,type:`color`,default:[.4,0,0,1]}]},er=s({default:()=>tr}),tr={id:`infinite_spiral_pro`,name:`Infinite Spiral`,category:`Abstract`,description:`Mathematical spirograph with static interlocking floral loops.`,shader:`
    vec4 generate() {
      vec2 uv = (v_uv - 0.5) * u_scale;
      float r = length(uv);
  ...
  `,uniforms:[{id:`u_scale`,name:`Spiral Power`,type:`float`,min:1,max:10,default:5},{id:`u_primary_color`,name:`Ink Color`,type:`color`,default:[1,1,1,1]},{id:`u_secondary_color`,name:`Background`,type:`color`,default:[0,0,0,1]}]},nr=s({default:()=>rr}),rr={id:`iris_fibers_artisan`,name:`Iris Fibers`,category:`Natural`,description:`Radial organic fibrous patterns found in the human eye iris.`,shader:`
    float hash(vec2 p) { return fract(sin(dot(p, vec2(127.1, 311.7))) * 43758.5453); }
    vec4 generate() {
      vec2 uv = (v_uv - 0.5) * 2.0;
      float d = length(uv);
  ...
  `,uniforms:[{id:`u_primary_color`,name:`Pupil Edge`,type:`color`,default:[.1,.3,.6,1]},{id:`u_secondary_color`,name:`Outer Stroma`,type:`color`,default:[0,.05,.1,1]}]},ir=s({default:()=>ar}),ar={id:`julia_fractal`,name:`Julia Set`,category:`Abstract`,description:`High-symmetry mathematical fractal based on complex number seeds.`,shader:`
    vec4 generate() {
  ...
  `,uniforms:[{id:`u_scale`,name:`Fractal Size`,type:`float`,min:1,max:10,default:3},{id:`u_primary_color`,name:`Core Color`,type:`color`,default:[0,.8,1,1]},{id:`u_secondary_color`,name:`Outer Space`,type:`color`,default:[0,0,.1,1]}]},or=s({default:()=>sr}),sr={id:`kevlar_grid_artisan`,name:`Kevlar Weave`,category:`Industrial`,description:`Heavy tactical weave used in protective armor and performance gear.`,shader:`
    vec4 generate() {
      float lines = sin(v_uv.x * 400.0) * sin(v_uv.y * 400.0);
      float mask = smoothstep(-0.5, 0.5, lines);
      return mix(u_secondary_color, u_primary_color, mask);
    }
  `,uniforms:[{id:`u_primary_color`,name:`Kevlar Gold`,type:`color`,default:[.8,.7,.2,1]},{id:`u_secondary_color`,name:`Outer Mesh`,type:`color`,default:[.1,.1,.1,1]}]},cr=s({default:()=>lr}),lr={id:`lava_crust_pro`,name:`Lava Crust`,category:`Natural`,description:`Static volcanic cooling patterns with high-heat emission cracks.`,shader:`
    float hash(vec2 p) { return fract(sin(dot(p, vec2(127.1, 311.7))) * 43758.5453); }
    float noise(vec2 p) {
      vec2 i = floor(p); vec2 f = fract(p);
      f = f*f*(3.0-2.0*f);
  ...
  `,uniforms:[{id:`u_scale`,name:`Flow Intensity`,type:`float`,min:1,max:10,default:4}]},ur=s({default:()=>dr}),dr={id:`leaf_skeleton_pro`,name:`Leaf Skeleton`,category:`Natural`,description:`Technical vein structure mimicking a decaying leaf skeleton.`,shader:`
    float hash(vec2 p) { return fract(sin(dot(p, vec2(127.1, 311.7))) * 43758.5453); }
    vec4 generate() {
      vec2 uv = v_uv * u_scale;
      vec2 gv = fract(uv);
  ...
  `,uniforms:[{id:`u_primary_color`,name:`Lichen High`,type:`color`,default:[.7,.8,.5,1]},{id:`u_secondary_color`,name:`Rock Base`,type:`color`,default:[.2,.2,.2,1]}]},mr=s({default:()=>hr}),hr={id:`lichtenberg_trees_artisan`,name:`Lichtenberg Trees`,category:`Experimental`,description:`Fractal electrical discharge patterns found in high-voltage dielectric breakdown.`,shader:`
    float hash(vec2 p) { return fract(sin(dot(p, vec2(127.1, 311.7))) * 43758.5453); }
    vec4 generate() {
  ...
  `,uniforms:[{id:`u_primary_color`,name:`Discharge`,type:`color`,default:[.4,.8,1,1]},{id:`u_secondary_color`,name:`Insulator`,type:`color`,default:[.05,.05,.08,1]}]},gr=s({default:()=>_r}),_r={id:`linear_gradient_artisan`,name:`Master Linear`,category:`Utility`,description:`High-precision linear gradient for base transitions.`,shader:`
    vec4 generate() {
      float mask = v_uv.x;
      return mix(u_secondary_color, u_primary_color, mask);
    }
  `,uniforms:[{id:`u_primary_color`,name:`Start Color`,type:`color`,default:[1,1,1,1]},{id:`u_secondary_color`,name:`End Color`,type:`color`,default:[0,0,0,1]}]},vr=s({default:()=>yr}),yr={id:`liquid_mercury_artisan`,name:`Liquid Mercury`,category:`Abstract`,description:`Smooth, blobby metallic shapes with high specularity mimicking liquid metal.`,shader:`
    float hash(vec2 p) { return fract(sin(dot(p, vec2(127.1, 311.7))) * 43758.5453); }
    float noise(vec2 p) {
      vec2 i = floor(p); vec2 f = fract(p);
      f = f*f*(3.0-2.0*f);
  ...
  `,uniforms:[{id:`u_scale`,name:`Blob Size`,type:`float`,min:1,max:10,default:5},{id:`u_primary_color`,name:`Mercury`,type:`color`,default:[.8,.8,.85,1]},{id:`u_secondary_color`,name:`Void`,type:`color`,default:[.1,.1,.12,1]}]},br=s({default:()=>xr}),xr={id:`louis_check_artisan`,name:`Louis Check`,category:`Abstract`,description:`Luxury designer-style checkered leather pattern with premium soft shading.`,shader:`
    vec4 generate() {
      vec2 uv = v_uv * u_scale;
      vec2 gv = floor(uv);
      float mask = mod(gv.x + gv.y, 2.0);
  ...
  `,uniforms:[{id:`u_scale`,name:`Check Zoom`,type:`float`,min:2,max:20,default:8},{id:`u_primary_color`,name:`Leather Dark`,type:`color`,default:[.3,.2,.15,1]},{id:`u_secondary_color`,name:`Leather Tan`,type:`color`,default:[.6,.45,.35,1]}]},Sr=s({default:()=>Cr}),Cr={id:`macrame_knot_artisan`,name:`Macrame Knot`,category:`Abstract`,description:`Interlocking geometric square knots found in traditional fiber crafts.`,shader:`
    vec4 generate() {
      vec2 uv = v_uv * u_scale;
      vec2 gv = fract(uv);
  ...
  `,uniforms:[{id:`u_scale`,name:`Knot Density`,type:`float`,min:2,max:20,default:8},{id:`u_primary_color`,name:`Cotton Rope`,type:`color`,default:[.95,.9,.85,1]},{id:`u_secondary_color`,name:`Knot Deep`,type:`color`,default:[.6,.55,.5,1]}]},wr=s({default:()=>Tr}),Tr={id:`mandelbrot_fractal`,name:`Mandelbrot Explorer`,category:`Abstract`,description:`Pure mathematical fractal boundary with high-precision iteration.`,shader:`
    vec4 generate() {
  ...
  `,uniforms:[{id:`u_scale`,name:`Zoom Level`,type:`float`,min:1,max:20,default:2},{id:`u_primary_color`,name:`Inner Glow`,type:`color`,default:[1,.4,0,1]},{id:`u_secondary_color`,name:`Void Depth`,type:`color`,default:[.05,0,.05,1]}]},Er=s({default:()=>Dr}),Dr={id:`maple_leaves_artisan`,name:`Maple Leaf Scatter`,category:`Natural`,description:`Randomly distributed maple leaf shapes with rotation and scale variance.`,shader:`
    float maple(vec2 p) {
  ...
  `,uniforms:[{id:`u_scale`,name:`Density`,type:`float`,min:2,max:15,default:6},{id:`u_primary_color`,name:`Leaf Color`,type:`color`,default:[1,.4,.1,1]},{id:`u_secondary_color`,name:`Background`,type:`color`,default:[.1,.1,.05,1]}]},Or=s({default:()=>kr}),kr={id:`marble_stone_artisan`,name:`Marbled Stone`,category:`Organic`,description:`Natural stone texture with randomized crystalline veins.`,shader:`
    float hash(vec2 p) { return fract(sin(dot(p, vec2(127.1, 311.7))) * 43758.5453123); }
    float noise(vec2 p) {
      vec2 i = floor(p); vec2 f = fract(p);
      f = f*f*(3.0-2.0*f);
  ...
  `,uniforms:[{id:`u_scale`,name:`Vein Density`,type:`float`,min:1,max:10,default:4},{id:`u_primary_color`,name:`Vein Color`,type:`color`,default:[.95,.95,1,1]},{id:`u_secondary_color`,name:`Stone Base`,type:`color`,default:[.3,.3,.35,1]}]},Ar=s({default:()=>jr}),jr={id:`micro_cells_artisan`,name:`Micro Cells`,category:`Natural`,description:`Biological cellular membranes and nuclei mimicking microscopic organic life.`,shader:`
    float hash(vec2 p) { return fract(sin(dot(p, vec2(127.1, 311.7))) * 43758.5453); }
    vec2 rand2(vec2 p) { return fract(sin(vec2(dot(p, vec2(127.1, 311.7)), dot(p, vec2(269.5, 183.3)))) * 43758.5453); }
    vec4 generate() {
      vec2 uv = v_uv * u_scale;
  ...
  `,uniforms:[{id:`u_scale`,name:`Cell Magnification`,type:`float`,min:2,max:20,default:8},{id:`u_primary_color`,name:`Organelle`,type:`color`,default:[.8,.4,.6,1]},{id:`u_secondary_color`,name:`Cytoplasm`,type:`color`,default:[.1,.05,.1,1]}]},Mr=s({default:()=>Nr}),Nr={id:`micro_logic_grid_artisan`,name:`Logic Array`,category:`Technology`,description:`Microscopic grid of semiconductor logic gates and data-bus structures.`,shader:`
    vec4 generate() {
      vec2 uv = v_uv * u_scale;
      float grid = step(0.95, fract(uv.x)) + step(0.95, fract(uv.y));
      return mix(u_secondary_color, u_primary_color, clamp(grid, 0.0, 1.0));
    }
  `,uniforms:[{id:`u_scale`,name:`Gate Matrix`,type:`float`,min:10,max:200,default:80},{id:`u_primary_color`,name:`Bus Copper`,type:`color`,default:[.8,1,0,1]},{id:`u_secondary_color`,name:`Silicon Base`,type:`color`,default:[.05,.05,.1,1]}]},Pr=s({default:()=>Fr}),Fr={id:`microchip_wafer_pro`,name:`Microchip Die`,category:`Technology`,description:`High-density silicon wafer etching with localized circuit density.`,shader:`
    float hash(vec2 p) { return fract(sin(dot(p, vec2(127.1, 311.7))) * 43758.5453); }
    vec4 generate() {
  ...
  `,uniforms:[{id:`u_scale`,name:`Wafer Density`,type:`float`,min:10,max:100,default:40},{id:`u_primary_color`,name:`Etched Metal`,type:`color`,default:[.7,.7,.75,1]},{id:`u_secondary_color`,name:`Silicon`,type:`color`,default:[.1,.1,.12,1]}]},Ir=s({default:()=>Lr}),Lr={id:`moire_silk_artisan`,name:`Moire Silk`,category:`Abstract`,description:`Water-like wavy fabric interference patterns found in heavy silk moire.`,shader:`
    vec4 generate() {
  ...
  `,uniforms:[{id:`u_primary_color`,name:`Sheen`,type:`color`,default:[.3,.35,.5,1]},{id:`u_secondary_color`,name:`Deep Silk`,type:`color`,default:[.1,.1,.2,1]}]},Rr=s({default:()=>zr}),zr={id:`monstera_leaf_artisan`,name:`Monstera Split-Leaf`,category:`Natural`,description:`The iconic tropical split-leaf silhouette with decorative voids.`,shader:`
  ...
  `,uniforms:[{id:`u_scale`,name:`Iridescence Detail`,type:`float`,min:1,max:10,default:3},{id:`u_primary_color`,name:`Shell Pearl`,type:`color`,default:[.9,.95,1,1]},{id:`u_secondary_color`,name:`Shell Deep`,type:`color`,default:[.8,.85,.9,1]}]},Hr=s({default:()=>Ur}),Ur={id:`mud_cracks_artisan`,name:`Dried Mud`,category:`Natural`,description:`High-fidelity organic polygonal fissures mimicking cracked desert earth.`,shader:`
    vec2 rand2(vec2 p) { return fract(sin(vec2(dot(p, vec2(127.1, 311.7)), dot(p, vec2(269.5, 183.3)))) * 43758.5453); }
    vec4 generate() {
      vec2 uv = v_uv * u_scale;
      vec2 i_uv = floor(uv);
  ...
  `,uniforms:[{id:`u_scale`,name:`Crack Density`,type:`float`,min:2,max:15,default:8},{id:`u_primary_color`,name:`Earth`,type:`color`,default:[.4,.3,.2,1]},{id:`u_secondary_color`,name:`Fissure`,type:`color`,default:[.15,.1,.05,1]}]},Wr=s({default:()=>Gr}),Gr={id:`mushroom_gills_artisan`,name:`Fungi Gills`,category:`Nature`,description:`Radiant organic ridges found on the underside of exotic fungal caps.`,shader:`
    vec4 generate() {
      vec2 uv = v_uv - 0.5;
      float angle = atan(uv.y, uv.x);
  ...
  `,uniforms:[{id:`u_scale`,name:`Gill Count`,type:`float`,min:20,max:200,default:80},{id:`u_primary_color`,name:`Gill Ridge`,type:`color`,default:[.8,.75,.7,1]},{id:`u_secondary_color`,name:`Cap Depth`,type:`color`,default:[.4,.35,.3,1]}]},Kr=s({default:()=>qr}),qr={id:`nanotech_cells_artisan`,name:`Nano Plating`,category:`Technology`,description:`Microscopic hexagonal active plating designed for dynamic aerodynamic surfaces.`,shader:`
    vec4 generate() {
      vec2 uv = v_uv * u_scale;
      if (mod(floor(uv.y), 2.0) == 0.0) uv.x += 0.5;
      vec2 gv = fract(uv) - 0.5;
  ...
  `,uniforms:[{id:`u_scale`,name:`Nano Zoom`,type:`float`,min:10,max:100,default:60},{id:`u_primary_color`,name:`Plate Surface`,type:`color`,default:[.15,.15,.18,1]},{id:`u_secondary_color`,name:`Nano Joint`,type:`color`,default:[0,.8,1,1]}]},Jr=s({default:()=>Yr}),Yr={id:`nappa_leather_artisan`,name:`Nappa Leather`,category:`Racing`,description:`Smooth premium leather grain with subtle organic pores found in high-end bucket seats.`,shader:`
    float hash(vec2 p) { return fract(sin(dot(p, vec2(127.1, 311.7))) * 43758.5453); }
    float noise(vec2 p) {
      vec2 i = floor(p); vec2 f = fract(p);
      f = f*f*(3.0-2.0*f);
  ...
  `,uniforms:[{id:`u_scale`,name:`Grain Zoom`,type:`float`,min:50,max:200,default:100},{id:`u_primary_color`,name:`Leather Top`,type:`color`,default:[.1,.1,.1,1]},{id:`u_secondary_color`,name:`Pore Deep`,type:`color`,default:[.05,.05,.05,1]}]},Xr=s({default:()=>Zr}),Zr={id:`nebula_dust_artisan`,name:`Nebula Dust`,category:`Natural`,description:`Soft, colored organic dust clouds found in interstellar gas formations.`,shader:`
    float hash(vec2 p) { return fract(sin(dot(p, vec2(127.1, 311.7))) * 43758.5453); }
    float noise(vec2 p) {
      vec2 i = floor(p); vec2 f = fract(p);
      return mix(mix(hash(i), hash(i+vec2(1,0)), f.x), mix(hash(i+vec2(0,1)), hash(i+vec2(1,1)), f.x), f.y);
  ...
  `,uniforms:[{id:`u_scale`,name:`Gas Density`,type:`float`,min:1,max:10,default:3},{id:`u_primary_color`,name:`Ionized Gas`,type:`color`,default:[.6,.1,.8,1]},{id:`u_secondary_color`,name:`Vacuum`,type:`color`,default:[0,0,.05,1]}]},Qr=s({default:()=>$r}),$r={id:`neon_tubes_artisan`,name:`Neon Path`,category:`Abstract`,description:`Glowing tubular neon paths mimicking high-fidelity urban lighting rigs.`,shader:`
    vec4 generate() {
      float y = fract(v_uv.y * u_scale);
      float mask = smoothstep(0.1, 0.2, y) * smoothstep(0.9, 0.8, y);
      return mix(u_secondary_color, u_primary_color, mask);
    }
  `,uniforms:[{id:`u_scale`,name:`Tube Count`,type:`float`,min:2,max:20,default:8},{id:`u_primary_color`,name:`Neon Glow`,type:`color`,default:[1,0,.5,1]},{id:`u_secondary_color`,name:`Vacuum Background`,type:`color`,default:[.05,0,.05,1]}]},ei=s({default:()=>ti}),ti={id:`neural_net_artisan`,name:`Neural Network`,category:`Technology`,description:`Interconnected nodes and synthetic logic lines mimicking artificial intelligence structures.`,shader:`
    vec2 rand2(vec2 p) { return fract(sin(vec2(dot(p, vec2(127.1, 311.7)), dot(p, vec2(269.5, 183.3)))) * 43758.5453); }
    vec4 generate() {
      vec2 uv = v_uv * u_scale;
      vec2 i_uv = floor(uv);
  ...
  `,uniforms:[{id:`u_scale`,name:`Node Density`,type:`float`,min:2,max:20,default:10},{id:`u_primary_color`,name:`Synapse`,type:`color`,default:[0,.8,1,1]},{id:`u_secondary_color`,name:`Neural Base`,type:`color`,default:[.01,.02,.05,1]}]},ni=s({default:()=>ri}),ri={id:`obsidian_fracture_artisan`,name:`Obsidian Flow`,category:`Geology`,description:`Sharp, mirror-like volcanic glass fractures found in fresh obsidian flows.`,shader:`
    float hash(vec2 p) { return fract(sin(dot(p, vec2(127.1, 311.7))) * 43758.5453); }
    vec4 generate() {
      float n = hash(floor(v_uv * u_scale));
      return mix(u_secondary_color, u_primary_color, n);
    }
  `,uniforms:[{id:`u_scale`,name:`Fracture Density`,type:`float`,min:2,max:20,default:10},{id:`u_primary_color`,name:`Glass High`,type:`color`,default:[.1,.1,.12,1]},{id:`u_secondary_color`,name:`Glass Shore`,type:`color`,default:[0,0,0,1]}]},ii=s({default:()=>ai}),ai={id:`oil_canvas_artisan`,name:`Oil Canvas Strokes`,category:`Abstract`,description:`Directional brush-stroke noise mimicking thick oil paint on canvas.`,shader:`
    float hash(vec2 p) { return fract(sin(dot(p, vec2(127.1, 311.7))) * 43758.5453); }
    vec4 generate() {
      vec2 uv = v_uv * u_scale;
  ...
  `,uniforms:[{id:`u_scale`,name:`Canvas Zoom`,type:`float`,min:1,max:10,default:4},{id:`u_primary_color`,name:`Paint Color`,type:`color`,default:[.6,.1,.2,1]},{id:`u_secondary_color`,name:`Canvas Weave`,type:`color`,default:[.8,.75,.7,1]}]},oi=s({default:()=>si}),si={id:`olive_branch_artisan`,name:`Olive Branch`,category:`Natural`,description:`Symmetrical leaf layering along a spine, symbolizing peace and precision.`,shader:`
    float leaf(vec2 p) {
      p = abs(p);
  ...
  `,uniforms:[{id:`u_scale`,name:`Shred Scale`,type:`float`,min:1,max:10,default:3},{id:`u_intensity`,name:`Aggression`,type:`float`,min:.1,max:5,default:2},{id:`u_primary_color`,name:`Top Layer`,type:`color`,default:[.1,.1,.1,1]},{id:`u_secondary_color`,name:`Deep Tear`,type:`color`,default:[.95,.95,.95,1]}]},fi=s({default:()=>pi}),pi={id:`pcb_traces_v3_artisan`,name:`Pro PCB Logic`,category:`Technology`,description:`Triple-layer circuit logic with advanced bus-routing and microscopic trace detail.`,shader:`
    vec4 generate() {
      float lines = sin(v_uv.x * 400.0) * sin(v_uv.y * 400.0);
      float mask = step(0.1, abs(lines));
      return mix(u_secondary_color, u_primary_color, mask);
    }
  `,uniforms:[{id:`u_primary_color`,name:`Trace Copper`,type:`color`,default:[1,.6,.1,1]},{id:`u_secondary_color`,name:`Substrate`,type:`color`,default:[0,.15,.05,1]}]},mi=s({default:()=>hi}),hi={id:`peacock_eyes_artisan`,name:`Peacock Eyes`,category:`Natural`,description:`Ornate organic pattern mimicking the "eyes" found in peacock feathers.`,shader:`
    vec4 generate() {
  ...
  `,uniforms:[{id:`u_scale`,name:`Eye Count`,type:`float`,min:2,max:20,default:6},{id:`u_primary_color`,name:`Eye Border`,type:`color`,default:[.1,.8,.3,1]},{id:`u_secondary_color`,name:`Feather Base`,type:`color`,default:[.05,.2,.05,1]}]},gi=s({default:()=>_i}),_i={id:`peat_moss_artisan`,name:`Peat Moss`,category:`Nature`,description:`Dense organic clumpy sprawl mimicking professional landscape and high-fidelity vegetation.`,shader:`
    float hash(vec2 p) { return fract(sin(dot(p, vec2(127.1, 311.7))) * 43758.5453); }
    float noise(vec2 p) {
      vec2 i = floor(p); vec2 f = fract(p);
      f = f*f*(3.0-2.0*f);
  ...
  `,uniforms:[{id:`u_scale`,name:`Moss Density`,type:`float`,min:20,max:200,default:80},{id:`u_primary_color`,name:`Moss High`,type:`color`,default:[.3,.4,.2,1]},{id:`u_secondary_color`,name:`Moss Deep`,type:`color`,default:[.1,.15,.05,1]}]},vi=s({default:()=>yi}),yi={id:`penrose_tiling_artisan`,name:`Penrose Mesh`,category:`Abstract`,description:`Aperiodic, non-repeating tiling lines mimicking complex mathematical quasicrystal structures.`,shader:`
    vec4 generate() {
      vec2 uv = (v_uv - 0.5) * u_scale;
  ...
  `,uniforms:[{id:`u_scale`,name:`Penrose Detail`,type:`float`,min:2,max:20,default:10},{id:`u_primary_color`,name:`Tiling Line`,type:`color`,default:[1,.8,0,1]},{id:`u_secondary_color`,name:`Void Space`,type:`color`,default:[.05,.05,.1,1]}]},bi=s({default:()=>xi}),xi={id:`petrified_wood_artisan`,name:`Petrified Wood`,category:`Geology`,description:`Fossilized wood grain with vibrant mineral staining and crystalized structures.`,shader:`
    float hash(vec2 p) { return fract(sin(dot(p, vec2(127.1, 311.7))) * 43758.5453); }
    float noise(vec2 p) {
      vec2 i = floor(p); vec2 f = fract(p);
      f = f*f*(3.0-2.0*f);
  ...
  `,uniforms:[{id:`u_primary_color`,name:`Chert High`,type:`color`,default:[.8,.4,.2,1]},{id:`u_secondary_color`,name:`Silt Deep`,type:`color`,default:[.4,.2,.1,1]}]},Si=s({default:()=>Ci}),Ci={id:`pine_bark_artisan`,name:`Pine Bark`,category:`Nature`,description:`Rough, vertical flaky ridges found on mature pine trees.`,shader:`
    float hash(vec2 p) { return fract(sin(dot(p, vec2(127.1, 311.7))) * 43758.5453); }
    vec4 generate() {
      float y = floor(v_uv.y * u_scale);
  ...
  `,uniforms:[{id:`u_scale`,name:`Bark Detail`,type:`float`,min:10,max:100,default:40},{id:`u_primary_color`,name:`Bark High`,type:`color`,default:[.3,.2,.15,1]},{id:`u_secondary_color`,name:`Bark Crevice`,type:`color`,default:[.15,.1,.08,1]}]},wi=s({default:()=>Ti}),Ti={id:`piston_top_artisan`,name:`Piston Head`,category:`Utility`,description:`Concentric rings of machined high-performance aluminum with heat seasoning.`,shader:`
    vec4 generate() {
      float d = length(v_uv - 0.5);
      float rings = sin(d * u_scale);
      float mask = smoothstep(-0.5, 0.5, rings);
  ...
  `,uniforms:[{id:`u_scale`,name:`Ring Density`,type:`float`,min:100,max:1e3,default:500},{id:`u_primary_color`,name:`Alloy High`,type:`color`,default:[.8,.8,.85,1]},{id:`u_secondary_color`,name:`Alloy Deep`,type:`color`,default:[.6,.6,.65,1]}]},Ei=s({default:()=>Di}),Di={id:`pixel_art_canvas_artisan`,name:`Pixel Grid`,category:`Abstract`,description:`Large-block quantized color grid mimicking retro 8-bit digital canvases.`,shader:`
    float hash(vec2 p) { return fract(sin(dot(p, vec2(127.1, 311.7))) * 43758.5453); }
    vec4 generate() {
      vec2 uv = floor(v_uv * u_scale);
      float n = hash(uv);
  ...
  `,uniforms:[{id:`u_scale`,name:`Pixel Size`,type:`float`,min:8,max:128,default:32},{id:`u_primary_color`,name:`Pixel High`,type:`color`,default:[1,1,1,1]},{id:`u_secondary_color`,name:`Pixel Dark`,type:`color`,default:[.5,.5,.5,1]}]},Oi=s({default:()=>ki}),ki={id:`plaid_tartan_artisan`,name:`Plaid Tartan`,category:`Abstract`,description:`Multi-colored interlocking textile grid found in classic Scottish kilts.`,shader:`
    vec4 generate() {
  ...
  `,uniforms:[{id:`u_scale`,name:`Grid Zoom`,type:`float`,min:2,max:20,default:10},{id:`u_primary_color`,name:`Stripe`,type:`color`,default:[1,0,0,1]},{id:`u_secondary_color`,name:`Base Wool`,type:`color`,default:[0,.2,.1,1]}]},Ai=s({default:()=>ji}),ji={id:`plant_cells_artisan`,name:`Plant Cells`,category:`Natural`,description:`Geometric hexagonal-ish stacked cells mimicking biological plant structures.`,shader:`
    vec2 rand2(vec2 p) { return fract(sin(vec2(dot(p, vec2(127.1, 311.7)), dot(p, vec2(269.5, 183.3)))) * 43758.5453); }
    vec4 generate() {
      vec2 uv = v_uv * u_scale;
      vec2 i_uv = floor(uv);
  ...
  `,uniforms:[{id:`u_scale`,name:`Cell Magnification`,type:`float`,min:2,max:15,default:8},{id:`u_primary_color`,name:`Chlorophyll`,type:`color`,default:[.2,.5,.1,1]},{id:`u_secondary_color`,name:`Cell Wall`,type:`color`,default:[.1,.2,.05,1]}]},Mi=s({default:()=>Ni}),Ni={id:`plasma_core_artisan`,name:`Plasma Core`,category:`Abstract`,description:`Pulsing radial energy patterns mimicking high-energy physics experiment cores.`,shader:`
    vec4 generate() {
      float d = length(v_uv - 0.5);
  ...
  `,uniforms:[{id:`u_scale`,name:`Refraction Density`,type:`float`,min:2,max:15,default:8}]},Ri=s({default:()=>zi}),zi={id:`pulsar_radial_artisan`,name:`Pulsar Radial`,category:`Abstract`,description:`High-frequency radial pulses mimicking deep-space electromagnetic emissions.`,shader:`
    vec4 generate() {
      float d = length(v_uv - 0.5);
  ...
  `,uniforms:[{id:`u_scale`,name:`Pulse Freq`,type:`float`,min:50,max:500,default:200},{id:`u_primary_color`,name:`Pulsar Beam`,type:`color`,default:[1,1,1,1]},{id:`u_secondary_color`,name:`Space Void`,type:`color`,default:[0,0,0,1]}]},Bi=s({default:()=>Vi}),Vi={id:`quantum_foam_artisan`,name:`Quantum Foam`,category:`Experimental`,description:`Abstract probability interference and grain noise mimicking fluctuations at the Planck scale.`,shader:`
    float hash(vec2 p) { return fract(sin(dot(p, vec2(127.1, 311.7))) * 43758.5453); }
    vec4 generate() {
      float n = hash(v_uv * u_scale) * hash(v_uv * u_scale * 1.1);
      return mix(u_secondary_color, u_primary_color, n);
    }
  `,uniforms:[{id:`u_scale`,name:`Planck Resolution`,type:`float`,min:100,max:1e3,default:500},{id:`u_primary_color`,name:`Fluctuation`,type:`color`,default:[1,1,1,1]},{id:`u_secondary_color`,name:`Vacuum`,type:`color`,default:[0,0,.05,1]}]},Hi=s({default:()=>A}),A={id:`quartz_crystal_artisan`,name:`Quartz Plane`,category:`Geology`,description:`Sharp geometric crystalline planes and internal mineral prisms.`,shader:`
    vec4 generate() {
      float d = abs(v_uv.x - 0.5) + abs(v_uv.y - 0.5);
      float mask = step(0.4, fract(d * u_scale));
      return mix(u_secondary_color, u_primary_color, mask);
    }
  `,uniforms:[{id:`u_scale`,name:`Crystal Zoom`,type:`float`,min:2,max:20,default:10},{id:`u_primary_color`,name:`Quartz Face`,type:`color`,default:[.9,.9,.95,1]},{id:`u_secondary_color`,name:`Prism Core`,type:`color`,default:[.8,.8,.9,1]}]},j=s({default:()=>Ui}),Ui={id:`radial_gradient_artisan`,name:`Master Radial`,category:`Utility`,description:`Focus-aligned radial gradient transition.`,shader:`
    vec4 generate() {
      float d = length(v_uv - 0.5) * 2.0;
      float mask = smoothstep(0.0, 1.0, d);
      return mix(u_primary_color, u_secondary_color, mask);
    }
  `,uniforms:[{id:`u_primary_color`,name:`Center Color`,type:`color`,default:[1,1,1,1]},{id:`u_secondary_color`,name:`Outer Color`,type:`color`,default:[0,0,0,1]}]},Wi=s({default:()=>Gi}),Gi={id:`reaction_diffusion_artisan`,name:`Reaction Diffusion`,category:`Experimental`,description:`Organic biological growth and coral-like patterns mimicking chemical morphogenesis.`,shader:`
    float hash(vec2 p) { return fract(sin(dot(p, vec2(127.1, 311.7))) * 43758.5453); }
    float noise(vec2 p) {
      vec2 i = floor(p); vec2 f = fract(p);
      return mix(mix(hash(i), hash(i+vec2(1,0)), f.x), mix(hash(i+vec2(0,1)), hash(i+vec2(1,1)), f.x), f.y);
  ...
  `,uniforms:[{id:`u_scale`,name:`Growth Scale`,type:`float`,min:2,max:20,default:8},{id:`u_primary_color`,name:`Organism`,type:`color`,default:[.8,.4,.2,1]},{id:`u_secondary_color`,name:`Substrate`,type:`color`,default:[.1,.05,0,1]}]},Ki=s({default:()=>qi}),qi={id:`realistic_viper_artisan`,name:`Realistic Viper`,category:`Natural`,description:`Small, diamond-shaped high-fidelity interlocking scales mimicking viper skin.`,shader:`
    vec4 generate() {
      mat2 m = mat2(0.707, -0.707, 0.707, 0.707);
      vec2 uv = m * v_uv * u_scale;
      vec2 gv = floor(uv);
  ...
  `,uniforms:[{id:`u_scale`,name:`Grain Density`,type:`float`,min:10,max:80,default:40},{id:`u_primary_color`,name:`Scales`,type:`color`,default:[.1,.15,.05,1]},{id:`u_secondary_color`,name:`Skin Deep`,type:`color`,default:[0,.05,0,1]}]},Ji=s({default:()=>Yi}),Yi={id:`rim_spoke_carbon_artisan`,name:`Spoke Carbon`,category:`Racing`,description:`Multi-layered carbon strands optimized for high-strength wheel spokes.`,shader:`
    vec4 generate() {
      vec2 uv = v_uv * u_scale;
  ...
  `,uniforms:[{id:`u_scale`,name:`Wave Density`,type:`float`,min:20,max:200,default:100},{id:`u_primary_color`,name:`Fiber Top`,type:`color`,default:[.2,.2,.22,1]},{id:`u_secondary_color`,name:`Resin Base`,type:`color`,default:[.1,.1,.12,1]}]},Xi=s({default:()=>Zi}),Zi={id:`river_cobble_artisan`,name:`River Cobble`,category:`Natural`,description:`Smooth, irregular organic stone clusters mimicking riverbed masonry.`,shader:`
    float hash(vec2 p) { return fract(sin(dot(p, vec2(127.1, 311.7))) * 43758.5453); }
    vec2 random2(vec2 p) { return fract(sin(vec2(dot(p, vec2(127.1, 311.7)), dot(p, vec2(269.5, 183.3)))) * 43758.5453); }
    vec4 generate() {
      vec2 uv = v_uv * u_scale;
  ...
  `,uniforms:[{id:`u_scale`,name:`Density`,type:`float`,min:2,max:20,default:8},{id:`u_primary_color`,name:`Stone Grey`,type:`color`,default:[.6,.6,.65,1]},{id:`u_secondary_color`,name:`Joint`,type:`color`,default:[.1,.1,.1,1]}]},Qi=s({default:()=>$i}),$i={id:`river_stone_artisan`,name:`River Stones`,category:`Nature`,description:`Smooth rounded pebble shapes mimicking naturally eroded riverbed stones.`,shader:`
  ...
  `,uniforms:[{id:`u_scale`,name:`Stone Size`,type:`float`,min:2,max:20,default:10},{id:`u_primary_color`,name:`Pebble Surface`,type:`color`,default:[.5,.5,.5,1]},{id:`u_secondary_color`,name:`Joint Sediment`,type:`color`,default:[.3,.3,.3,1]}]},ea=s({default:()=>ta}),ta={id:`rivet_lines_pro`,name:`Panel Rivets`,category:`Industrial`,description:`Structural rivet seams for automotive panels.`,shader:`
    vec4 generate() {
  ...
  `,uniforms:[{id:`u_scale`,name:`Rivet Spacing`,type:`float`,min:5,max:50,default:20},{id:`u_primary_color`,name:`Rivet`,type:`color`,default:[.6,.6,.6,1]},{id:`u_secondary_color`,name:`Panel`,type:`color`,default:[.35,.35,.35,1]}]},na=s({default:()=>ra}),ra={id:`rivet_plate_elite`,name:`Rivet Plate Elite`,category:`Industrial`,description:`Overlapping heavy armor sections with structural corner rivets.`,shader:`
    vec4 generate() {
      vec2 uv = v_uv * u_scale;
      vec2 gv = fract(uv);
  ...
  `,uniforms:[{id:`u_scale`,name:`Plate Count`,type:`float`,min:1,max:10,default:4},{id:`u_primary_color`,name:`Armor Steel`,type:`color`,default:[.5,.5,.55,1]},{id:`u_secondary_color`,name:`Seam`,type:`color`,default:[.1,.1,.12,1]}]},ia=s({default:()=>aa}),aa={id:`roll_cage_foam_artisan`,name:`Roll Cage Foam`,category:`Racing`,description:`Dense, pitted cellular protective foam found on professional roll cage padding.`,shader:`
    vec2 rand2(vec2 p) { return fract(sin(vec2(dot(p, vec2(127.1, 311.7)), dot(p, vec2(269.5, 183.3)))) * 43758.5453); }
    vec4 generate() {
      vec2 uv = v_uv * u_scale;
      vec2 i_uv = floor(uv);
  ...
  `,uniforms:[{id:`u_scale`,name:`Cell Density`,type:`float`,min:2,max:20,default:10},{id:`u_primary_color`,name:`Foam Body`,type:`color`,default:[.1,.1,.1,1]},{id:`u_secondary_color`,name:`Pore Shade`,type:`color`,default:[.05,.05,.05,1]}]},oa=s({default:()=>sa}),sa={id:`roof_shingles_artisan`,name:`Scalloped Shingles`,category:`Industrial`,description:`Overlapping curved roofing tiles used in architectural design.`,shader:`
    vec4 generate() {
      vec2 uv = v_uv * u_scale;
      if (mod(floor(uv.y), 2.0) == 0.0) uv.x += 0.5;
      vec2 gv = fract(uv);
  ...
  `,uniforms:[{id:`u_scale`,name:`Branching`,type:`float`,min:2,max:20,default:8},{id:`u_primary_color`,name:`Root Fiber`,type:`color`,default:[.5,.4,.3,1]},{id:`u_secondary_color`,name:`Soil Deep`,type:`color`,default:[.1,.08,.05,1]}]},ua=s({default:()=>da}),da={id:`safety_harness_artisan`,name:`Safety Harness`,category:`Racing`,description:`Heavy-duty nylon web weave found in 5-point and 6-point racing harnesses.`,shader:`
    vec4 generate() {
      vec2 uv = v_uv * 40.0;
  ...
  `,uniforms:[{id:`u_primary_color`,name:`Nylon Web`,type:`color`,default:[.5,0,0,1]},{id:`u_secondary_color`,name:`Weave Gap`,type:`color`,default:[.1,0,0,1]}]},fa=s({default:()=>pa}),pa={id:`sand_dunes_artisan`,name:`Sand Dunes`,category:`Natural`,description:`Rippling wave-like ridges found in vast desert wastelands and oceanic floors.`,shader:`
    vec4 generate() {
      float waves = sin(v_uv.x * 20.0 * u_scale + sin(v_uv.y * 10.0));
      float mask = smoothstep(-0.5, 0.5, waves);
      return mix(u_secondary_color, u_primary_color, mask);
    }
  `,uniforms:[{id:`u_scale`,name:`Dune Frequency`,type:`float`,min:.5,max:3,default:1},{id:`u_primary_color`,name:`Sunlight`,type:`color`,default:[.9,.7,.4,1]},{id:`u_secondary_color`,name:`Shadow`,type:`color`,default:[.4,.3,.15,1]}]},ma=s({default:()=>M}),M={id:`sandstone_layers_artisan`,name:`Sandstone Strata`,category:`Geology`,description:`Fine horizontal layers and sediments found in weathered sandstone walls.`,shader:`
    float hash(float n) { return fract(sin(n) * 43758.5453); }
    vec4 generate() {
  ...
  `,uniforms:[{id:`u_scale`,name:`Strata Density`,type:`float`,min:20,max:200,default:100},{id:`u_primary_color`,name:`Sediment High`,type:`color`,default:[.8,.6,.4,1]},{id:`u_secondary_color`,name:`Sediment Deep`,type:`color`,default:[.6,.4,.3,1]}]},ha=s({default:()=>ga}),ga={id:`seat_perforation_artisan`,name:`Seat Perforation`,category:`Racing`,description:`Grid of fine ventilation holes found in professional bucket seats and luxury automotive leather.`,shader:`
    vec4 generate() {
      vec2 uv = v_uv * u_scale;
      vec2 gv = fract(uv) - 0.5;
      float d = length(gv);
  ...
  `,uniforms:[{id:`u_scale`,name:`Hole Density`,type:`float`,min:10,max:100,default:40},{id:`u_primary_color`,name:`Punch Hold`,type:`color`,default:[0,0,0,1]},{id:`u_secondary_color`,name:`Leather Surface`,type:`color`,default:[.1,.1,.1,1]}]},_a=s({default:()=>va}),va={id:`server_rack_mesh_artisan`,name:`Server Mesh`,category:`Industrial`,description:`Industrial perforated metal mesh found on high-density enterprise server racks.`,shader:`
    vec4 generate() {
      vec2 uv = v_uv * u_scale;
      if (mod(floor(uv.y), 2.0) == 0.0) uv.x += 0.5;
      vec2 gv = fract(uv) - 0.5;
  ...
  `,uniforms:[{id:`u_scale`,name:`Mesh Zoom`,type:`float`,min:10,max:100,default:50},{id:`u_primary_color`,name:`Steel Rack`,type:`color`,default:[.1,.1,.1,1]},{id:`u_secondary_color`,name:`Internal Shadow`,type:`color`,default:[0,0,0,1]}]},ya=s({default:()=>ba}),ba={id:`shift_boot_leather_artisan`,name:`Shift Boot Leather`,category:`Racing`,description:`Organic crumpled leather folds and distressed textures found in shift boots and gaiters.`,shader:`
    float hash(vec2 p) { return fract(sin(dot(p, vec2(127.1, 311.7))) * 43758.5453); }
    float noise(vec2 p) {
      vec2 i = floor(p); vec2 f = fract(p);
      f = f*f*(3.0-2.0*f);
  ...
  `,uniforms:[{id:`u_primary_color`,name:`Leather High`,type:`color`,default:[.12,.1,.08,1]},{id:`u_secondary_color`,name:`Fold Shadow`,type:`color`,default:[.05,.04,.03,1]}]},xa=s({default:()=>Sa}),Sa={id:`sierpinski_mesh_artisan`,name:`Fractal Mesh`,category:`Abstract`,description:`Recursive Sierpinski triangle fractal structures found in high-performance lightweight parts.`,shader:`
    vec4 generate() {
        vec2 uv = v_uv;
        float mask = 0.0;
        for (int i=0; i<4; i++) {
  ...
  `,uniforms:[{id:`u_primary_color`,name:`Fractal Web`,type:`color`,default:[0,1,.5,1]},{id:`u_secondary_color`,name:`Fractal Hole`,type:`color`,default:[0,.1,.05,1]}]},Ca=s({default:()=>wa}),wa={id:`skeletal_mesh_artisan`,name:`Skeletal Mesh`,category:`Abstract`,description:`Periodic rib-like line patterns with organic jitter found in anatomical structures.`,shader:`
    vec4 generate() {
      float ribs = sin(v_uv.y * 50.0 * u_scale + sin(v_uv.x * 20.0));
      float mask = smoothstep(0.0, 0.1, ribs);
      return mix(u_secondary_color, u_primary_color, mask);
    }
  `,uniforms:[{id:`u_scale`,name:`Rib Frequency`,type:`float`,min:.1,max:2,default:1},{id:`u_primary_color`,name:`Bone`,type:`color`,default:[.9,.9,.85,1]},{id:`u_secondary_color`,name:`Marrow`,type:`color`,default:[.1,.05,.05,1]}]},Ta=s({default:()=>Ea}),Ea={id:`snake_skin_artisan`,name:`Snake Skin`,category:`Natural`,description:`Precisely interlocking reptilian scales with organic variance.`,shader:`
    vec4 generate() {
      vec2 uv = v_uv * u_scale;
      if (mod(floor(uv.y), 2.0) == 0.0) uv.x += 0.5;
      vec2 gv = fract(uv) - 0.5;
  ...
  `,uniforms:[{id:`u_scale`,name:`Scale Density`,type:`float`,min:10,max:100,default:40},{id:`u_primary_color`,name:`Scale Color`,type:`color`,default:[.2,.4,.1,1]},{id:`u_secondary_color`,name:`Underlayer`,type:`color`,default:[.05,.1,.02,1]}]},Da=s({default:()=>Oa}),Oa={id:`snake_skin_v2_artisan`,name:`Viper Scales`,category:`Nature`,description:`Interlocking diamond scales found in aggressive predatory reptilian hide.`,shader:`
    vec4 generate() {
      vec2 uv = v_uv * u_scale;
      if (mod(floor(uv.y), 2.0) == 0.0) uv.x += 0.5;
      vec2 gv = fract(uv) - 0.5;
  ...
  `,uniforms:[{id:`u_scale`,name:`Scale Zoom`,type:`float`,min:10,max:100,default:40},{id:`u_primary_color`,name:`Dorsal Scale`,type:`color`,default:[.1,.2,.1,1]},{id:`u_secondary_color`,name:`Inter-scale`,type:`color`,default:[0,0,0,1]}]},ka=s({default:()=>Aa}),Aa={id:`solar_flare_pro`,name:`Solar Flare`,category:`Abstract`,description:`Static plasma energy flux with high-intensity radiation centers.`,shader:`
    float hash(vec2 p) { return fract(sin(dot(p, vec2(127.1, 311.7))) * 43758.5453); }
    float noise(vec2 p) {
      vec2 i = floor(p); vec2 f = fract(p);
      f = f*f*(3.0-2.0*f);
  ...
  `,uniforms:[{id:`u_scale`,name:`Flare Scale`,type:`float`,min:1,max:10,default:4},{id:`u_primary_color`,name:`Plasma Heat`,type:`color`,default:[1,.8,.2,1]},{id:`u_secondary_color`,name:`Corona`,type:`color`,default:[.5,.1,0,1]}]},ja=s({default:()=>Ma}),Ma={id:`solar_flares_v2_artisan`,name:`Solar Corona`,category:`Natural`,description:`Abstract high-energy atmospheric flares and plasma smears from a stellar corona.`,shader:`
    float hash(vec2 p) { return fract(sin(dot(p, vec2(127.1, 311.7))) * 43758.5453); }
    vec4 generate() {
      vec2 uv = (v_uv - 0.5) * 2.0;
      float d = length(uv);
  ...
  `,uniforms:[{id:`u_primary_color`,name:`Core`,type:`color`,default:[1,.9,.3,1]},{id:`u_secondary_color`,name:`Ejection`,type:`color`,default:[.8,.2,0,0]}]},Na=s({default:()=>Pa}),Pa={id:`speed_trails_artisan`,name:`Speed Trails`,category:`Racing`,description:`Horizontal motion-style smears representing velocity and aerodynamic flow.`,shader:`
    float hash(float n) { return fract(sin(n) * 43758.5453); }
    vec4 generate() {
      float y = floor(v_uv.y * u_scale);
      float h = hash(y);
  ...
  `,uniforms:[{id:`u_scale`,name:`Trail Density`,type:`float`,min:10,max:100,default:50},{id:`u_primary_color`,name:`Trail Lite`,type:`color`,default:[1,1,1,1]},{id:`u_secondary_color`,name:`Void`,type:`color`,default:[0,0,0,0]}]},Fa=s({default:()=>Ia}),Ia={id:`spider_web_artisan`,name:`Silk Web`,category:`Nature`,description:`Radial-concentric silk networks found in professional predatory arachnid structures.`,shader:`
    vec4 generate() {
      vec2 uv = v_uv - 0.5;
      float d = length(uv);
      float angle = atan(uv.y, uv.x);
  ...
  `,uniforms:[{id:`u_primary_color`,name:`Silk Strand`,type:`color`,default:[.9,.9,1,1]},{id:`u_secondary_color`,name:`Void Backdrop`,type:`color`,default:[0,0,0,1]}]},La=s({default:()=>Ra}),Ra={id:`spray_drip_artisan`,name:`Spray Drip`,category:`Abstract`,description:`Static vertical paint drip effect mimicking street-art application.`,shader:`
    float hash(float n) { return fract(sin(n) * 43758.5453); }
    vec4 generate() {
  ...
  `,uniforms:[{id:`u_scale`,name:`Drip Count`,type:`float`,min:10,max:100,default:40},{id:`u_primary_color`,name:`Drip Color`,type:`color`,default:[1,0,.2,1]},{id:`u_secondary_color`,name:`Background`,type:`color`,default:[.05,.05,.05,1]}]},za=s({default:()=>Ba}),Ba={id:`stained_glass_artisan`,name:`Stained Glass`,category:`Abstract`,description:`Lead-outlined colored polygons mimicking traditional stained glass craftsmanship.`,shader:`
    ...
    float hash(vec2 p) { return fract(sin(dot(p, vec2(127.1, 311.7))) * 43758.5453); }
  `,uniforms:[{id:`u_scale`,name:`Glass Sections`,type:`float`,min:2,max:20,default:8}]},Va=s({default:()=>Ha}),Ha={id:`star_field_artisan`,name:`Star Field Static`,category:`Natural`,description:`High-density thresholded noise clusters representing deep-space star fields.`,shader:`
    float hash(vec2 p) { return fract(sin(dot(p, vec2(127.1, 311.7))) * 43758.5453); }
    vec4 generate() {
      float n = hash(v_uv * u_scale);
  ...
  `,uniforms:[{id:`u_primary_color`,name:`Star Streak`,type:`color`,default:[1,1,1,1]},{id:`u_secondary_color`,name:`Deep Space`,type:`color`,default:[0,0,0,1]}]},Ga=s({default:()=>Ka}),Ka={id:`steel_wool_artisan`,name:`Steel Wool`,category:`Industrial`,description:`Chaos-line noise mimicking tangled metal strands found in industrial abrasives.`,shader:`
    float hash(vec2 p) { return fract(sin(dot(p, vec2(127.1, 311.7))) * 43758.5453); }
    vec4 generate() {
  ...
  `,uniforms:[{id:`u_primary_color`,name:`Steel Strand`,type:`color`,default:[.7,.7,.75,1]},{id:`u_secondary_color`,name:`Internal Shadow`,type:`color`,default:[.1,.1,.15,1]}]},qa=s({default:()=>Ja}),Ja={id:`stitched_leather_pro`,name:`Stitched Leather`,category:`Organic`,description:`Premium pebbled leather texture with perimeter stitching simulation.`,shader:`
    float hash(vec2 p) { return fract(sin(dot(p, vec2(127.1, 311.7))) * 43758.5453123); }
    vec4 generate() {
      vec2 uv = v_uv * u_scale;
      vec2 gv = fract(uv) - 0.5;
  ...
  `,uniforms:[{id:`u_primary_color`,name:`Pattern Edge`,type:`color`,default:[0,.8,1,1]},{id:`u_secondary_color`,name:`Deep Core`,type:`color`,default:[0,.1,.15,1]}]},Za=s({default:()=>Qa}),Qa={id:`tech_hex_v2_artisan`,name:`Tech Hex v2`,category:`Technology`,description:`Advanced geometric hex-grid with internal subdivided offsets for sci-fi panels.`,shader:`
  ...
  `,uniforms:[{id:`u_scale`,name:`Module Count`,type:`float`,min:2,max:20,default:10},{id:`u_primary_color`,name:`Housing`,type:`color`,default:[0,.8,1,1]},{id:`u_secondary_color`,name:`Frame`,type:`color`,default:[.05,.05,.08,1]}]},$a=s({default:()=>eo}),eo={id:`terrazzo_stone_artisan`,name:`Terrazzo Stone`,category:`Industrial`,description:`Multi-colored irregular stone chunks embedded in a polished composite base.`,shader:`
    vec2 rand2(vec2 p) { return fract(sin(vec2(dot(p, vec2(127.1, 311.7)), dot(p, vec2(269.5, 183.3)))) * 43758.5453); }
    vec4 generate() {
      vec2 uv = v_uv * u_scale;
      vec2 i_uv = floor(uv);
  ...
  `,uniforms:[{id:`u_scale`,name:`Chip Density`,type:`float`,min:2,max:20,default:8},{id:`u_primary_color`,name:`Stone Chip`,type:`color`,default:[.6,.62,.65,1]},{id:`u_secondary_color`,name:`Base Mortar`,type:`color`,default:[.8,.8,.82,1]}]},to=s({default:()=>no}),no={id:`threaded_screw_artisan`,name:`Threaded Bolt`,category:`Industrial`,description:`Helical metal grooves representing industrial fasteners and bolts.`,shader:`
    vec4 generate() {
      vec2 uv = v_uv * u_scale;
  ...
  `,uniforms:[{id:`u_scale`,name:`Thread Pitch`,type:`float`,min:1,max:10,default:5},{id:`u_primary_color`,name:`Peak Metal`,type:`color`,default:[.9,.9,.95,1]},{id:`u_secondary_color`,name:`Valley`,type:`color`,default:[.1,.1,.15,1]}]},ro=s({default:()=>io}),io={id:`tiger_stripes_artisan`,name:`Predator Stripes`,category:`Organic`,description:`Organic predator-style tiger stripes with tapered edges.`,shader:`
    float hash(vec2 p) { return fract(sin(dot(p, vec2(127.1, 311.7))) * 43758.5453123); }
    float noise(vec2 p) {
      vec2 i = floor(p); vec2 f = fract(p);
      f = f*f*(3.0-2.0*f);
  ...
  `,uniforms:[{id:`u_scale`,name:`Detail Zoom`,type:`float`,min:2,max:20,default:10},{id:`u_primary_color`,name:`Rubber High`,type:`color`,default:[.15,.15,.15,1]},{id:`u_secondary_color`,name:`Rubber Base`,type:`color`,default:[.08,.08,.08,1]}]},lo=s({default:()=>uo}),uo={id:`tire_tread_rain`,name:`Rain Tire Tread`,category:`Racing`,description:`Deep directional grooves for wet weather conditions.`,shader:`
    vec4 generate() {
      vec2 uv = v_uv * u_scale;
  ...
  `,uniforms:[{id:`u_scale`,name:`Density`,type:`float`,min:2,max:20,default:8},{id:`u_primary_color`,name:`Rubber`,type:`color`,default:[.15,.15,.15,1]},{id:`u_secondary_color`,name:`Groove`,type:`color`,default:[.05,.05,.05,1]}]},fo=s({default:()=>po}),po={id:`topographic_pro`,name:`Topographic Map`,category:`Abstract`,description:`Technical contour lines mimicking elevation mapping.`,shader:`
    float hash(vec2 p) { return fract(sin(dot(p, vec2(127.1, 311.7))) * 43758.5453123); }
    float noise(vec2 p) {
      vec2 i = floor(p); vec2 f = fract(p);
      f = f*f*(3.0-2.0*f);
  ...
  `,uniforms:[{id:`u_scale`,name:`Territory Size`,type:`float`,min:1,max:10,default:3},{id:`u_layers`,name:`Contour Detail`,type:`float`,min:5,max:50,default:20},{id:`u_primary_color`,name:`Line Color`,type:`color`,default:[1,1,1,1]},{id:`u_secondary_color`,name:`Land Color`,type:`color`,default:[.1,.1,.1,1]}]},mo=s({default:()=>ho}),ho={id:`truchet_tiles_artisan`,name:`Truchet Arc`,category:`Abstract`,description:`Interlocking arc-based tiles mimicking complex organic circuitry and decorative pavement.`,shader:`
    float hash(vec2 p) { return fract(sin(dot(p, vec2(127.1, 311.7))) * 43758.5453); }
    vec4 generate() {
      vec2 uv = v_uv * u_scale;
      vec2 i_uv = floor(uv);
  ...
  `,uniforms:[{id:`u_scale`,name:`Tile Zoom`,type:`float`,min:2,max:20,default:10},{id:`u_primary_color`,name:`Arc Ribbon`,type:`color`,default:[1,.4,0,1]},{id:`u_secondary_color`,name:`Tile Depth`,type:`color`,default:[.1,.1,.15,1]}]},go=s({default:()=>_o}),_o={id:`turbo_fan_artisan`,name:`Turbo Turbine`,category:`Technology`,description:`Radial blades of a high-boost turbocharger compressor wheel.`,shader:`
    vec4 generate() {
      vec2 uv = v_uv - 0.5;
      float angle = atan(uv.y, uv.x);
  ...
  `,uniforms:[{id:`u_blades`,name:`Blade Count`,type:`float`,min:6,max:24,default:12},{id:`u_primary_color`,name:`Blade Top`,type:`color`,default:[.9,.92,.95,1]},{id:`u_secondary_color`,name:`Blade Void`,type:`color`,default:[.1,.1,.15,1]}]},N=s({default:()=>vo}),vo={id:`twill_carbon_pro`,name:`Pro Twill Carbon`,category:`Racing`,description:`Classic high-detail 2x2 carbon fiber weave.`,shader:`
    vec4 generate() {
      vec2 uv = v_uv * u_scale;
      vec2 gv = fract(uv);
      vec2 id = floor(uv);
  ...
  `,uniforms:[{id:`u_scale`,name:`Weave Size`,type:`float`,min:10,max:100,default:40},{id:`u_primary_color`,name:`Primary`,type:`color`,default:[.12,.12,.12,1]},{id:`u_secondary_color`,name:`Secondary`,type:`color`,default:[.05,.05,.05,1]}]},yo=s({default:()=>P}),P={id:`void_grid_artisan`,name:`Void Grid`,category:`Abstract`,description:`Infinite perspective grid reminiscent of 1980s retro-futuristic digital visualization.`,shader:`
    vec4 generate() {
      vec2 uv = v_uv * u_scale;
      float grid = step(0.95, fract(uv.x)) + step(0.95, fract(uv.y));
      return mix(u_secondary_color, u_primary_color, clamp(grid, 0.0, 1.0));
    }
  `,uniforms:[{id:`u_scale`,name:`Grid Density`,type:`float`,min:5,max:50,default:20},{id:`u_primary_color`,name:`Grid Glow`,type:`color`,default:[1,0,1,1]},{id:`u_secondary_color`,name:`Void Base`,type:`color`,default:[0,0,.05,1]}]},F=s({default:()=>I}),I={id:`volcanic_basalt_artisan`,name:`Basalt Pillar`,category:`Geology`,description:`Pitted, geometric volcanic rock found in hexagonal basalt formations.`,shader:`
    vec4 generate() {
      vec2 uv = v_uv * u_scale;
      if (mod(floor(uv.y), 2.0) == 0.0) uv.x += 0.5;
      vec2 gv = fract(uv) - 0.5;
  ...
  `,uniforms:[{id:`u_scale`,name:`Cell Count`,type:`float`,min:2,max:20,default:8},{id:`u_primary_color`,name:`Cell Center`,type:`color`,default:[.2,.2,.25,1]},{id:`u_secondary_color`,name:`Cell Border`,type:`color`,default:[.1,.1,.12,1]}]},So=s({default:()=>Co}),Co={id:`water_ripples_artisan`,name:`Water Ripples`,category:`Natural`,description:`Static concentric liquid wave interference patterns.`,shader:`
    vec4 generate() {
      vec2 uv = (v_uv - 0.5) * u_scale;
      float d = length(uv);
  ...
  `,uniforms:[{id:`u_scale`,name:`Wave Scale`,type:`float`,min:1,max:10,default:5},{id:`u_primary_color`,name:`Peak Color`,type:`color`,default:[.1,.6,1,1]},{id:`u_secondary_color`,name:`Deep Water`,type:`color`,default:[0,.2,.4,1]}]},wo=s({default:()=>To}),To={id:`watercolor_bleed_artisan`,name:`Watercolor Flow`,category:`Abstract`,description:`Soft organic color spreads and bleeding textures mimicking paint on high-fidelity wet paper.`,shader:`
    float hash(vec2 p) { return fract(sin(dot(p, vec2(127.1, 311.7))) * 43758.5453); }
    float noise(vec2 p) {
      vec2 i = floor(p); vec2 f = fract(p);
      f = f*f*(3.0-2.0*f);
  ...
  `,uniforms:[{id:`u_primary_color`,name:`Ink Bleed`,type:`color`,default:[.2,.4,.8,.8]},{id:`u_secondary_color`,name:`Pulp Base`,type:`color`,default:[.95,.95,.9,1]}]},Eo=s({default:()=>L}),L={id:`wavy_checkers_artisan`,name:`Wavy Checkers`,category:`Racing`,description:`Flowing, distorted racing flags mimicking a waving checkered banner.`,shader:`
    vec4 generate() {
      vec2 uv = v_uv * u_scale;
  ...
  `,uniforms:[{id:`u_scale`,name:`Chip Detail`,type:`float`,min:5,max:50,default:10},{id:`u_primary_color`,name:`Paint`,type:`color`,default:[.8,.1,.1,1]},{id:`u_secondary_color`,name:`Exposed Metal`,type:`color`,default:[.3,.3,.35,1]}]},ko=s({default:()=>Ao}),Ao={id:`weathered_rust_pro`,name:`Weathered Rust`,category:`Industrial`,description:`Pro-grade oxidizing metallic surface with realistic pitting and oxidation layers.`,shader:`
    float hash(vec2 p) { return fract(sin(dot(p, vec2(127.1, 311.7))) * 43758.5453123); }
    float noise(vec2 p) {
      vec2 i = floor(p); vec2 f = fract(p);
      f = f*f*(3.0-2.0*f);
  ...
  `,uniforms:[{id:`u_scale`,name:`Rust Intensity`,type:`float`,min:1,max:20,default:5}]},jo=s({default:()=>Mo}),Mo={id:`wicker_weave_artisan`,name:`Wicker Weave`,category:`Natural`,description:`Interlocking thick strands of woven wood found in traditional basketry.`,shader:`
    vec4 generate() {
      vec2 uv = v_uv * u_scale;
      float w = floor(uv.y);
  ...
  `,uniforms:[{id:`u_scale`,name:`Weave Density`,type:`float`,min:2,max:20,default:8},{id:`u_primary_color`,name:`Wicker Slat`,type:`color`,default:[.7,.5,.3,1]},{id:`u_secondary_color`,name:`Joint Deep`,type:`color`,default:[.2,.1,.05,1]}]},No=s({default:()=>Po}),Po={id:`wood_grain_artisan`,name:`Wood Grain Pro`,category:`Natural`,description:`High-detail procedural timber with concentric growth rings and knots.`,shader:`
    float hash(vec2 p) { return fract(sin(dot(p, vec2(127.1, 311.7))) * 43758.5453); }
    float noise(vec2 p) {
      vec2 i = floor(p); vec2 f = fract(p);
      f = f*f*(3.0-2.0*f);
  ...
  `,uniforms:[{id:`u_scale`,name:`Wood density`,type:`float`,min:1,max:10,default:4},{id:`u_primary_color`,name:`Grain Color`,type:`color`,default:[.3,.15,.05,1]},{id:`u_secondary_color`,name:`Base Timber`,type:`color`,default:[.45,.25,.1,1]}]},Fo=s({default:()=>R}),R={id:`wood_parquet_artisan`,name:`Wood Parquet`,category:`Industrial`,description:`Complex interlocking geometric floor planks for premium interior design.`,shader:`
    vec4 generate() {
      vec2 uv = v_uv * u_scale;
      vec2 gv = floor(uv);
      float mask = mod(gv.x + gv.y, 2.0);
  ...
  `,uniforms:[{id:`u_scale`,name:`Mosaic Size`,type:`float`,min:2,max:20,default:10},{id:`u_primary_color`,name:`Plank A`,type:`color`,default:[.5,.3,.1,1]},{id:`u_secondary_color`,name:`Plank B`,type:`color`,default:[.4,.25,.08,1]}]},Io=s({default:()=>Lo}),Lo={id:`zebra_camo_v2_artisan`,name:`Zebra Camo v2`,category:`Abstract`,description:`High-contrast geometric distortion variant of precision camouflages.`,shader:`
    vec4 generate() {
      vec2 uv = v_uv * u_scale;
      float mask = step(0.5, fract(uv.x + sin(uv.y * 2.0)));
      return mix(u_secondary_color, u_primary_color, mask);
    }
  `,uniforms:[{id:`u_scale`,name:`Pattern Density`,type:`float`,min:1,max:10,default:5},{id:`u_primary_color`,name:`Stripe A`,type:`color`,default:[0,0,0,1]},{id:`u_secondary_color`,name:`Stripe B`,type:`color`,default:[1,1,1,1]}]},Ro=[`All`,`Racing`,`Geometric`,`Technology`,`Organic`,`Utility`,`Industrial`,`Abstract`,`Natural`],zo=Object.values(Object.assign({"./patterns/acid_etch.js":x,"./patterns/alcantara_suede.js":S,"./patterns/anodized_titanium.js":te,"./patterns/apex_curbing.js":re,"./patterns/argyle_knit.js":ie,"./patterns/asphalt_pro.js":oe,"./patterns/autumn_leaves.js":ce,"./patterns/banded_agate.js":ue,"./patterns/barbed_wire.js":E,"./patterns/bird_plumage.js":fe,"./patterns/blueprint_grid.js":me,"./patterns/bone_pores.js":O,"./patterns/braided_cord.js":ge,"./patterns/brain_coral.js":ve,"./patterns/brake_dust.js":be,"./patterns/brake_rotor_wear.js":Se,"./patterns/brake_rotors.js":we,"./patterns/brick_masonry.js":Ee,"./patterns/brushed_aluminum.js":Oe,"./patterns/burlap_sack.js":Ae,"./patterns/butterfly_wing.js":Me,"./patterns/cactus_needles.js":Pe,"./patterns/canvas_rip.js":Ie,"./patterns/carpet_velour.js":Re,"./patterns/chain_mail.js":Be,"./patterns/charcoal_sketch.js":He,"./patterns/chopped_carbon.js":We,"./patterns/circuit_traces.js":Ke,"./patterns/coral_reef.js":Je,"./patterns/corduroy_rib.js":Xe,"./patterns/corrugated_steel.js":Qe,"./patterns/crocodile_hide.js":et,"./patterns/cyber_grid.js":nt,"./patterns/cyber_leather.js":it,"./patterns/cyber_twill.js":ot,"./patterns/cyber_wiring.js":ct,"./patterns/damask_silk.js":ut,"./patterns/data_matrix.js":ft,"./patterns/demon_scales.js":mt,"./patterns/denim_weave.js":gt,"./patterns/desert_dunes.js":vt,"./patterns/diamond_plate.js":bt,"./patterns/diamond_quilt.js":St,"./patterns/diamond_stitch_v2.js":wt,"./patterns/diatom_shells.js":Et,"./patterns/diffraction_grating.js":Ot,"./patterns/digi_camo_urban.js":kt,"./patterns/digital_camo_v2.js":jt,"./patterns/digital_glitch.js":Nt,"./patterns/door_panel_fabric.js":Ft,"./patterns/dragon_plate.js":Lt,"./patterns/energy_shield.js":zt,"./patterns/etched_brass.js":Vt,"./patterns/exhaust_heat.js":Ut,"./patterns/expanded_grating.js":Gt,"./patterns/fiber_optic_bundle.js":qt,"./patterns/fingerprint_swirls.js":Yt,"./patterns/fish_scales.js":Zt,"./patterns/fluid_marbling.js":$t,"./patterns/forest_litter.js":tn,"./patterns/forged_carbon.js":rn,"./patterns/frost_crystals.js":on,"./patterns/frozen_lake.js":cn,"./patterns/fusion_panel.js":un,"./patterns/galvanized_steel.js":fn,"./patterns/gauge_cluster.js":mn,"./patterns/glacier_ice.js":gn,"./patterns/glass_shards.js":vn,"./patterns/glitch_interference.js":bn,"./patterns/gold_leaf.js":Sn,"./patterns/gothic_filigree.js":wn,"./patterns/gravel_trap.js":En,"./patterns/greek_key.js":On,"./patterns/halftone_dots.js":An,"./patterns/halftone_pop.js":Mn,"./patterns/hammered_copper.js":Pn,"./patterns/harlequin_diamond.js":In,"./patterns/headliner_mesh.js":Rn,"./patterns/herringbone.js":Bn,"./patterns/hex_mesh.js":Hn,"./patterns/holographic_glitch.js":Wn,"./patterns/honeycomb_bio.js":Kn,"./patterns/houndstooth.js":Jn,"./patterns/hunting_camo.js":Xn,"./patterns/impasto_paint.js":Qn,"./patterns/infinite_spiral.js":er,"./patterns/iris_fibers.js":nr,"./patterns/julia_fractal.js":ir,"./patterns/kevlar_grid.js":or,"./patterns/lava_crust.js":cr,"./patterns/leaf_skeleton.js":ur,"./patterns/lichen_growth.js":fr,"./patterns/lichtenberg_trees.js":mr,"./patterns/linear_gradient.js":gr,"./patterns/liquid_mercury.js":vr,"./patterns/louis_check.js":br,"./patterns/macrame_knot.js":Sr,"./patterns/mandelbrot_fractal.js":wr,"./patterns/maple_leaves.js":Er,"./patterns/marble_stone.js":Or,"./patterns/micro_cells.js":Ar,"./patterns/micro_logic_grid.js":Mr,"./patterns/microchip_wafer.js":Pr,"./patterns/moire_silk.js":Ir,"./patterns/monstera_leaf.js":Rr,"./patterns/mother_of_pearl.js":Br,"./patterns/mud_cracks.js":Hr,"./patterns/mushroom_gills.js":Wr,"./patterns/nanotech_cells.js":Kr,"./patterns/nappa_leather.js":Jr,"./patterns/nebula_dust.js":Xr,"./patterns/neon_tubes.js":Qr,"./patterns/neural_net.js":ei,"./patterns/obsidian_fracture.js":ni,"./patterns/oil_canvas.js":ii,"./patterns/olive_branch.js":oi,"./patterns/palm_fronds.js":ci,"./patterns/paper_tear.js":ui,"./patterns/pcb_traces_v3.js":fi,"./patterns/peacock_eyes.js":mi,"./patterns/peat_moss.js":gi,"./patterns/penrose_tiling.js":vi,"./patterns/petrified_wood.js":bi,"./patterns/pine_bark.js":Si,"./patterns/piston_top.js":wi,"./patterns/pixel_art_canvas.js":Ei,"./patterns/plaid_tartan.js":Oi,"./patterns/plant_cells.js":Ai,"./patterns/plasma_core.js":Mi,"./patterns/polka_dot.js":Pi,"./patterns/prism_shards.js":Ii,"./patterns/pulsar_radial.js":Ri,"./patterns/quantum_foam.js":Bi,"./patterns/quartz_crystal.js":Hi,"./patterns/radial_gradient.js":j,"./patterns/reaction_diffusion.js":Wi,"./patterns/realistic_viper.js":Ki,"./patterns/rim_spoke_carbon.js":Ji,"./patterns/river_cobble.js":Xi,"./patterns/river_stone.js":Qi,"./patterns/rivet_lines.js":ea,"./patterns/rivet_plate_elite.js":na,"./patterns/roll_cage_foam.js":ia,"./patterns/roof_shingles.js":oa,"./patterns/root_system.js":ca,"./patterns/safety_harness.js":ua,"./patterns/sand_dunes.js":fa,"./patterns/sandstone_layers.js":ma,"./patterns/seat_perforation.js":ha,"./patterns/server_rack_mesh.js":_a,"./patterns/shift_boot_leather.js":ya,"./patterns/sierpinski_mesh.js":xa,"./patterns/skeletal_mesh.js":Ca,"./patterns/snake_skin.js":Ta,"./patterns/snake_skin_v2.js":Da,"./patterns/solar_flare.js":ka,"./patterns/solar_flares_v2.js":ja,"./patterns/speed_trails.js":Na,"./patterns/spider_web.js":Fa,"./patterns/spray_drip.js":La,"./patterns/stained_glass.js":za,"./patterns/star_field.js":Va,"./patterns/starlight_drive.js":Ua,"./patterns/steel_wool.js":Ga,"./patterns/stitched_leather.js":qa,"./patterns/tech_fractal.js":Ya,"./patterns/tech_hex_v2.js":Za,"./patterns/terrazzo_stone.js":$a,"./patterns/threaded_screw.js":to,"./patterns/tiger_stripes.js":ro,"./patterns/tire_marbles.js":ao,"./patterns/tire_sidewall.js":so,"./patterns/tire_tread_rain.js":lo,"./patterns/topo_map.js":fo,"./patterns/truchet_tiles.js":mo,"./patterns/turbo_fan.js":go,"./patterns/twill_carbon.js":N,"./patterns/void_grid.js":yo,"./patterns/volcanic_basalt.js":F,"./patterns/voronoi_cells.js":bo,"./patterns/water_ripples.js":So,"./patterns/watercolor_bleed.js":wo,"./patterns/wavy_checkers.js":Eo,"./patterns/weathered_paint.js":Do,"./patterns/weathered_rust.js":ko,"./patterns/wicker_weave.js":jo,"./patterns/wood_grain_pro.js":No,"./patterns/wood_parquet.js":Fo,"./patterns/zebra_camo_v2.js":Io})).map(e=>e.default),Bo=(...e)=>e.filter((e,t,n)=>!!e&&e.trim()!==``&&n.indexOf(e)===t).join(` `).trim(),Vo=e=>e.replace(/([a-z0-9])([A-Z])/g,`$1-$2`).toLowerCase(),Ho=e=>e.replace(/^([A-Z])|[\s-_]+(\w)/g,(e,t,n)=>n?n.toUpperCase():t.toLowerCase()),Uo=e=>{let t=Ho(e);return t.charAt(0).toUpperCase()+t.slice(1)},Wo={xmlns:`http://www.w3.org/2000/svg`,width:24,height:24,viewBox:`0 0 24 24`,fill:`none`,stroke:`currentColor`,strokeWidth:2,strokeLinecap:`round`,strokeLinejoin:`round`},Go=e=>{for(let t in e)if(t.startsWith(`aria-`)||t===`role`||t===`title`)return!0;return!1},Ko=(0,v.createContext)({}),qo=()=>(0,v.useContext)(Ko),Jo=(0,v.forwardRef)(({color:e,size:t,strokeWidth:n,absoluteStrokeWidth:r,className:i=``,children:a,iconNode:o,...s},c)=>{let{size:l=24,strokeWidth:u=2,absoluteStrokeWidth:d=!1,color:f=`currentColor`,className:p=``}=qo()??{},m=r??d?Number(n??u)*24/Number(t??l):n??u;return(0,v.createElement)(`svg`,{ref:c,...Wo,width:t??l??Wo.width,height:t??l??Wo.height,stroke:e??f,strokeWidth:m,className:Bo(`lucide`,p,i),...!a&&!Go(s)&&{"aria-hidden":`true`},...s},[...o.map(([e,t])=>(0,v.createElement)(e,t)),...Array.isArray(a)?a:[a]])}),Yo=(e,t)=>{let n=(0,v.forwardRef)(({className:n,...r},i)=>(0,v.createElement)(Jo,{ref:i,iconNode:t,className:Bo(`lucide-${Vo(Uo(e))}`,`lucide-${e}`,n),...r}));return n.displayName=Uo(e),n},Xo=Yo(`download`,[[`path`,{d:`M12 15V3`,key:`m9g1x1`}],[`path`,{d:`M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4`,key:`ih7n3h`}],[`path`,{d:`m7 10 5 5 5-5`,key:`brsn70`}]]),Zo=Yo(`info`,[[`circle`,{cx:`12`,cy:`12`,r:`10`,key:`1mglay`}],[`path`,{d:`M12 16v-4`,key:`1dtifu`}],[`path`,{d:`M12 8h.01`,key:`e9boi3`}]]),Qo=Yo(`layers`,[[`path`,{d:`M12.83 2.18a2 2 0 0 0-1.66 0L2.6 6.08a1 1 0 0 0 0 1.83l8.58 3.91a2 2 0 0 0 1.66 0l8.58-3.9a1 1 0 0 0 0-1.83z`,key:`zw3jo`}],[`path`,{d:`M2 12a1 1 0 0 0 .58.91l8.6 3.91a2 2 0 0 0 1.65 0l8.58-3.9A1 1 0 0 0 22 12`,key:`1wduqc`}],[`path`,{d:`M2 17a1 1 0 0 0 .58.91l8.6 3.91a2 2 0 0 0 1.65 0l8.58-3.9A1 1 0 0 0 22 17`,key:`kqbvx6`}]]),$o=Yo(`maximize`,[[`path`,{d:`M8 3H5a2 2 0 0 0-2 2v3`,key:`1dcmit`}],[`path`,{d:`M21 8V5a2 2 0 0 0-2-2h-3`,key:`1e4gt3`}],[`path`,{d:`M3 16v3a2 2 0 0 0 2 2h3`,key:`wsl5sc`}],[`path`,{d:`M16 21h3a2 2 0 0 0 2-2v-3`,key:`18trek`}]]),es=Yo(`search`,[[`path`,{d:`m21 21-4.34-4.34`,key:`14j7rj`}],[`circle`,{cx:`11`,cy:`11`,r:`8`,key:`4ej97u`}]]),ts=Yo(`settings`,[[`path`,{d:`M9.671 4.136a2.34 2.34 0 0 1 4.659 0 2.34 2.34 0 0 0 3.319 1.915 2.34 2.34 0 0 1 2.33 4.033 2.34 2.34 0 0 0 0 3.831 2.34 2.34 0 0 1-2.33 4.033 2.34 2.34 0 0 0-3.319 1.915 2.34 2.34 0 0 1-4.659 0 2.34 2.34 0 0 0-3.32-1.915 2.34 2.34 0 0 1-2.33-4.033 2.34 2.34 0 0 0 0-3.831A2.34 2.34 0 0 1 6.35 6.051a2.34 2.34 0 0 0 3.319-1.915`,key:`1i5ecw`}],[`circle`,{cx:`12`,cy:`12`,r:`3`,key:`1v7zrd`}]]),ns=Yo(`shield`,[[`path`,{d:`M20 13c0 5-3.5 7.5-7.66 8.95a1 1 0 0 1-.67-.01C7.5 20.5 4 18 4 13V6a1 1 0 0 1 1-1c2 0 4.5-1.2 6.24-2.72a1.17 1.17 0 0 1 1.52 0C14.51 3.81 17 5 19 5a1 1 0 0 1 1 1z`,key:`oel41y`}]]),rs=Yo(`x`,[[`path`,{d:`M18 6 6 18`,key:`1bl5f8`}],[`path`,{d:`m6 6 12 12`,key:`d8bk6v`}]]),is=Yo(`zap`,[[`path`,{d:`M4 14a1 1 0 0 1-.78-1.63l9.9-10.2a.5.5 0 0 1 .86.46l-1.92 6.02A1 1 0 0 0 13 10h7a1 1 0 0 1 .78 1.63l-9.9 10.2a.5.5 0 0 1-.86-.46l1.92-6.02A1 1 0 0 0 11 14z`,key:`1xq2db`}]]),as=o((e=>{var t=Symbol.for(`react.transitional.element`);function n(e,n,r){var i=null;if(r!==void 0&&(i=``+r),n.key!==void 0&&(i=``+n.key),`key`in n)for(var a in r={},n)a!==`key`&&(r[a]=n[a]);else r=n;return n=r.ref,{$$typeof:t,type:e,key:i,ref:n===void 0?null:n,props:r}}e.jsx=n,e.jsxs=n})),z=o(((e,t)=>{t.exports=as()}))();function os(){let e=(0,v.useRef)(null),t=(0,v.useRef)(null),[n,r]=(0,v.useState)(zo[0]),[i,a]=(0,v.useState)({}),[o,s]=(0,v.useState)(!1),[c,l]=(0,v.useState)(2048),[u,d]=(0,v.useState)(!0),f=window.electronAPI!==void 0,[p,m]=(0,v.useState)(``),[h,g]=(0,v.useState)(`All`),[_,y]=(0,v.useState)(``),[x,ee]=(0,v.useState)(!1),[S,C]=(0,v.useState)(!1),[te,ne]=(0,v.useState)(null),[re,w]=(0,v.useState)([]),[ie,ae]=(0,v.useState)(1),oe=(0,v.useMemo)(()=>zo.filter(e=>{let t=e.name.toLowerCase().includes(p.toLowerCase())||e.description.toLowerCase().includes(p.toLowerCase()),n=h===`All`||e.category===h;return t&&n}),[p,h]);(0,v.useEffect)(()=>{if(!e.current)return;let r=new b(e.current);return t.current=r,se(n),()=>r.stop()},[e]),(0,v.useEffect)(()=>{let n=()=>{if(!t.current||!e.current)return;let n=u?340:0;e.current.width=window.innerWidth-n-40,e.current.height=window.innerHeight-100};return window.addEventListener(`resize`,n),n(),()=>window.removeEventListener(`resize`,n)},[u]),(0,v.useEffect)(()=>{window.electronAPI&&(window.electronAPI.onUpdateStatus(e=>{y(e),w(t=>[...t.slice(-4),e])}),window.electronAPI.onUpdateAvailableData(e=>{ee(!0),ne(e),w(t=>[...t.slice(-4),`v${e.version} found on GitHub`])}),window.electronAPI.onUpdateDownloaded(()=>{C(!0),ee(!1),w(e=>[...e.slice(-4),`Update ready — click to install`])}))},[]),(0,v.useEffect)(()=>{t.current&&t.current.render({u_opacity:ie})},[ie]);let se=async e=>{if(!t.current)return;let n={};e.uniforms.forEach(e=>{n[e.id]=e.default}),a(n),await t.current.setShader(e),t.current.render({...n,u_is_spec:+!!o})},ce=e=>{r(e),se(e)},le=(e,n)=>{let r={...i,[e]:n};a(r),t.current&&t.current.render({...r,u_is_spec:+!!o})};(0,v.useEffect)(()=>{t.current&&t.current.render({u_is_spec:+!!o})},[o]);let ue=()=>{if(!t.current)return;let e=t.current.export(c,c,{...i,u_is_spec:+!!o}),r=document.createElement(`a`);r.download=`simtex_${n.id}_${o?`spec`:`diff`}_${c}.png`,r.href=e,r.click()},T=e=>{let t=e=>Math.round(e*255).toString(16).padStart(2,`0`);return`#${t(e[0])}${t(e[1])}${t(e[2])}`},E=(e,t=1)=>[parseInt(e.slice(1,3),16)/255,parseInt(e.slice(3,5),16)/255,parseInt(e.slice(5,7),16)/255,t];return(0,z.jsxs)(`div`,{className:`app-container`,children:[(0,z.jsxs)(`aside`,{className:`sidebar glass-panel ${u?`open`:`closed`}`,children:[(0,z.jsxs)(`div`,{className:`sidebar-top`,children:[(0,z.jsx)(`div`,{className:`sidebar-header`,children:(0,z.jsxs)(`div`,{className:`logo`,children:[(0,z.jsx)(ns,{size:24,color:`var(--color-accent)`}),(0,z.jsxs)(`h1`,{children:[`SIMTEX`,(0,z.jsx)(`span`,{children:`PRO`}),` `,(0,z.jsx)(`small`,{className:`v-tag`,children:`v3.0.0`})]})]})}),(0,z.jsxs)(`section`,{className:`sidebar-section`,children:[(0,z.jsxs)(`div`,{className:`search-wrapper`,children:[(0,z.jsx)(es,{size:16,className:`search-icon`}),(0,z.jsx)(`input`,{type:`text`,placeholder:`Search patterns...`,value:p,onChange:e=>m(e.target.value),className:`search-input`}),p&&(0,z.jsx)(rs,{size:14,className:`clear-search`,onClick:()=>m(``)})]}),(0,z.jsx)(`div`,{className:`category-tabs pro-scrollbar`,children:Ro.map(e=>(0,z.jsx)(`button`,{className:`category-tab ${h===e?`active`:``}`,onClick:()=>g(e),children:e},e))})]})]}),(0,z.jsxs)(`section`,{className:`patterns-container pro-scrollbar`,children:[(0,z.jsxs)(`div`,{className:`section-title`,children:[(0,z.jsx)(Qo,{size:16}),(0,z.jsxs)(`span`,{children:[`PATTERNS (`,oe.length,`)`]})]}),(0,z.jsx)(`div`,{className:`pattern-grid`,children:oe.length>0?oe.map(e=>(0,z.jsxs)(`button`,{className:`pattern-card ${n.id===e.id?`active`:``}`,onClick:()=>ce(e),children:[(0,z.jsxs)(`div`,{className:`card-header`,children:[(0,z.jsx)(`div`,{className:`pattern-name`,children:e.name}),(0,z.jsx)(`div`,{className:`pattern-category`,children:e.category})]}),(0,z.jsx)(`div`,{className:`pattern-desc`,children:e.description})]},e.id)):(0,z.jsxs)(`div`,{className:`no-results`,children:[`No patterns found for "`,p,`"`]})})]}),(0,z.jsxs)(`div`,{className:`sidebar-bottom`,children:[(0,z.jsxs)(`section`,{className:`sidebar-section`,children:[(0,z.jsxs)(`div`,{className:`section-title`,children:[(0,z.jsx)(ts,{size:16}),(0,z.jsx)(`span`,{children:`CONTROLS`})]}),(0,z.jsxs)(`div`,{className:`controls-list pro-scrollbar`,children:[(0,z.jsxs)(`div`,{className:`control-group master-control`,children:[(0,z.jsxs)(`div`,{className:`control-label`,children:[(0,z.jsx)(`span`,{children:`Master Opacity`}),(0,z.jsxs)(`span`,{className:`control-value`,children:[(ie*100).toFixed(0),`%`]})]}),(0,z.jsx)(`input`,{type:`range`,min:`0`,max:`1`,step:`0.01`,value:ie,onChange:e=>ae(parseFloat(e.target.value))})]}),n.uniforms.map(e=>(0,z.jsxs)(`div`,{className:`control-group`,children:[(0,z.jsxs)(`div`,{className:`control-label`,children:[(0,z.jsx)(`span`,{children:e.name}),(0,z.jsx)(`span`,{className:`control-value`,children:e.type===`color`?``:(i[e.id]||0).toFixed(2)})]}),e.type===`float`?(0,z.jsx)(`input`,{type:`range`,min:e.min,max:e.max,step:(e.max-e.min)/100,value:i[e.id]||e.default,onChange:t=>le(e.id,parseFloat(t.target.value))}):(0,z.jsxs)(`div`,{className:`color-control-stack`,children:[(0,z.jsx)(`input`,{type:`color`,className:`color-input`,value:i[e.id]?T(i[e.id]):`#ffffff`,onChange:t=>le(e.id,E(t.target.value,i[e.id]?i[e.id][3]:1))}),(0,z.jsxs)(`div`,{className:`alpha-slider-row`,children:[(0,z.jsx)(`span`,{className:`alpha-label`,children:`Alpha`}),(0,z.jsx)(`input`,{type:`range`,min:`0`,max:`1`,step:`0.01`,value:i[e.id]?i[e.id][3]:1,onChange:t=>{let n=i[e.id]||[1,1,1,1];le(e.id,[n[0],n[1],n[2],parseFloat(t.target.value)])}})]})]})]},e.id))]})]}),(0,z.jsxs)(`section`,{className:`sidebar-section`,children:[(0,z.jsxs)(`div`,{className:`section-title`,children:[(0,z.jsx)(is,{size:16}),(0,z.jsx)(`span`,{children:`MATERIAL MODE`})]}),(0,z.jsxs)(`div`,{className:`mode-toggle`,children:[(0,z.jsx)(`button`,{className:`toggle-btn ${o?``:`active`}`,onClick:()=>s(!1),children:`Standard`}),(0,z.jsx)(`button`,{className:`toggle-btn ${o?`active`:``}`,onClick:()=>s(!0),children:`iRacing Spec`})]}),o&&(0,z.jsxs)(`div`,{className:`info-box`,children:[(0,z.jsx)(Zo,{size:14}),(0,z.jsx)(`p`,{children:`R: Metallic | G: Roughness`})]})]}),re.length>0&&(0,z.jsxs)(`div`,{className:`update-console`,children:[re.map((e,t)=>(0,z.jsx)(`div`,{className:`log-entry`,children:e},t)),x&&(0,z.jsxs)(`button`,{className:`btn-update-action download`,onClick:()=>window.electronAPI.downloadUpdate(),children:[`Download v`,te?.version]}),S&&(0,z.jsx)(`button`,{className:`btn-update-action install`,onClick:()=>window.electronAPI.restartAndInstall(),children:`Install & Restart`})]})]}),(0,z.jsxs)(`div`,{className:`sidebar-footer`,children:[(0,z.jsx)(`span`,{className:`version-label`,children:`v2.1.4`}),f&&(0,z.jsx)(`button`,{className:`check-updates-link`,onClick:()=>window.electronAPI?.checkForUpdates(),children:`Check for Updates`})]})]}),(0,z.jsxs)(`main`,{className:`main-content`,children:[(0,z.jsxs)(`header`,{className:`top-bar glass-panel`,children:[(0,z.jsx)(`div`,{className:`res-selector`,children:[1024,2048,4096].map(e=>(0,z.jsxs)(`button`,{onClick:()=>l(e),className:c===e?`active`:``,children:[e/1024,`K`]},e))}),(0,z.jsxs)(`div`,{className:`actions`,children:[(0,z.jsx)(`button`,{className:`btn-secondary`,onClick:()=>d(!u),children:(0,z.jsx)($o,{size:18})}),(0,z.jsxs)(`button`,{className:`btn-primary`,onClick:ue,children:[(0,z.jsx)(Xo,{size:18}),(0,z.jsx)(`span`,{children:`Export PNG`})]})]})]}),(0,z.jsx)(`div`,{className:`viewport`,children:(0,z.jsxs)(`div`,{className:`canvas-wrapper`,children:[(0,z.jsx)(`canvas`,{ref:e}),(0,z.jsx)(`div`,{className:`canvas-overlay`,children:(0,z.jsxs)(`span`,{children:[c,` x `,c,` PREVIEW`]})})]})})]}),(0,z.jsx)(`style`,{children:`
