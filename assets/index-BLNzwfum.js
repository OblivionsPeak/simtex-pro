...
void main() { 
  ...
  `,uniforms:[{id:`u_primary_color`,name:`Fractal Web`,type:`color`,default:[0,1,.5,1]},{id:`u_secondary_color`,name:`Fractal Hole`,type:`color`,default:[0,.1,.05,1]}]},za=s({default:()=>Ba}),Ba={id:`skeletal_mesh_artisan`,name:`Skeletal Mesh`,category:`Abstract`,description:`Periodic rib-like line patterns with organic jitter found in anatomical structures.`,shader:`
    vec4 generate() {
      float ribs = sin(v_uv.y * 50.0 * u_scale + sin(v_uv.x * 20.0));
      float mask = smoothstep(0.0, 0.1, ribs);
      return mix(u_secondary_color, u_primary_color, mask);
    }
  `,uniforms:[{id:`u_scale`,name:`Rib Frequency`,type:`float`,min:.1,max:2,default:1},{id:`u_primary_color`,name:`Bone`,type:`color`,default:[.9,.9,.85,1]},{id:`u_secondary_color`,name:`Marrow`,type:`color`,default:[.1,.05,.05,1]}]},Va=s({default:()=>Ha}),Ha={id:`snake_skin_artisan`,name:`Snake Skin`,category:`Natural`,description:`Precisely interlocking reptilian scales with organic variance.`,shader:`
    vec4 generate() {
      vec2 uv = v_uv * u_scale;
      if (mod(floor(uv.y), 2.0) == 0.0) uv.x += 0.5;
      vec2 gv = fract(uv) - 0.5;
  ...
  `,uniforms:[{id:`u_scale`,name:`Scale Density`,type:`float`,min:10,max:100,default:40},{id:`u_primary_color`,name:`Scale Color`,type:`color`,default:[.2,.4,.1,1]},{id:`u_secondary_color`,name:`Underlayer`,type:`color`,default:[.05,.1,.02,1]}]},Ua=s({default:()=>Wa}),Wa={id:`snake_skin_v2_artisan`,name:`Viper Scales`,category:`Nature`,description:`Interlocking diamond scales found in aggressive predatory reptilian hide.`,shader:`
    vec4 generate() {
      vec2 uv = v_uv * u_scale;
      if (mod(floor(uv.y), 2.0) == 0.0) uv.x += 0.5;
      vec2 gv = fract(uv) - 0.5;
  ...
  `,uniforms:[{id:`u_scale`,name:`Scale Zoom`,type:`float`,min:10,max:100,default:40},{id:`u_primary_color`,name:`Dorsal Scale`,type:`color`,default:[.1,.2,.1,1]},{id:`u_secondary_color`,name:`Inter-scale`,type:`color`,default:[0,0,0,1]}]},Ga=s({default:()=>Ka}),Ka={id:`solar_flare_pro`,name:`Solar Flare`,category:`Abstract`,description:`Static plasma energy flux with high-intensity radiation centers.`,shader:`
    float hash(vec2 p) { return fract(sin(dot(p, vec2(127.1, 311.7))) * 43758.5453); }
    float noise(vec2 p) {
      vec2 i = floor(p); vec2 f = fract(p);
      f = f*f*(3.0-2.0*f);
  ...
  `,uniforms:[{id:`u_scale`,name:`Flare Scale`,type:`float`,min:1,max:10,default:4},{id:`u_primary_color`,name:`Plasma Heat`,type:`color`,default:[1,.8,.2,1]},{id:`u_secondary_color`,name:`Corona`,type:`color`,default:[.5,.1,0,1]}]},qa=s({default:()=>Ja}),Ja={id:`solar_flares_v2_artisan`,name:`Solar Corona`,category:`Natural`,description:`Abstract high-energy atmospheric flares and plasma smears from a stellar corona.`,shader:`
    float hash(vec2 p) { return fract(sin(dot(p, vec2(127.1, 311.7))) * 43758.5453); }
    vec4 generate() {
      vec2 uv = (v_uv - 0.5) * 2.0;
      float d = length(uv);
  ...
  `,uniforms:[{id:`u_primary_color`,name:`Core`,type:`color`,default:[1,.9,.3,1]},{id:`u_secondary_color`,name:`Ejection`,type:`color`,default:[.8,.2,0,0]}]},Ya=s({default:()=>Xa}),Xa={id:`speed_trails_artisan`,name:`Speed Trails`,category:`Racing`,description:`Horizontal motion-style smears representing velocity and aerodynamic flow.`,shader:`
    float hash(float n) { return fract(sin(n) * 43758.5453); }
    vec4 generate() {
      float y = floor(v_uv.y * u_scale);
      float h = hash(y);
  ...
  `,uniforms:[{id:`u_scale`,name:`Trail Density`,type:`float`,min:10,max:100,default:50},{id:`u_primary_color`,name:`Trail Lite`,type:`color`,default:[1,1,1,1]},{id:`u_secondary_color`,name:`Void`,type:`color`,default:[0,0,0,0]}]},Za=s({default:()=>Qa}),Qa={id:`spider_web_artisan`,name:`Silk Web`,category:`Nature`,description:`Radial-concentric silk networks found in professional predatory arachnid structures.`,shader:`
    vec4 generate() {
      vec2 uv = v_uv - 0.5;
      float d = length(uv);
      float angle = atan(uv.y, uv.x);
  ...
  `,uniforms:[{id:`u_primary_color`,name:`Silk Strand`,type:`color`,default:[.9,.9,1,1]},{id:`u_secondary_color`,name:`Void Backdrop`,type:`color`,default:[0,0,0,1]}]},$a=s({default:()=>eo}),eo={id:`spray_drip_artisan`,name:`Spray Drip`,category:`Abstract`,description:`Static vertical paint drip effect mimicking street-art application.`,shader:`
    float hash(float n) { return fract(sin(n) * 43758.5453); }
    vec4 generate() {
  ...
  `,uniforms:[{id:`u_scale`,name:`Drip Count`,type:`float`,min:10,max:100,default:40},{id:`u_primary_color`,name:`Drip Color`,type:`color`,default:[1,0,.2,1]},{id:`u_secondary_color`,name:`Background`,type:`color`,default:[.05,.05,.05,1]}]},to=s({default:()=>no}),no={id:`stained_glass_artisan`,name:`Stained Glass`,category:`Abstract`,description:`Lead-outlined colored polygons mimicking traditional stained glass craftsmanship.`,shader:`
    ...
    float hash(vec2 p) { return fract(sin(dot(p, vec2(127.1, 311.7))) * 43758.5453); }
  `,uniforms:[{id:`u_scale`,name:`Glass Sections`,type:`float`,min:2,max:20,default:8}]},ro=s({default:()=>io}),io={id:`star_field_artisan`,name:`Star Field Static`,category:`Natural`,description:`High-density thresholded noise clusters representing deep-space star fields.`,shader:`
    float hash(vec2 p) { return fract(sin(dot(p, vec2(127.1, 311.7))) * 43758.5453); }
    vec4 generate() {
      float n = hash(v_uv * u_scale);
  ...
  `,uniforms:[{id:`u_primary_color`,name:`Star Streak`,type:`color`,default:[1,1,1,1]},{id:`u_secondary_color`,name:`Deep Space`,type:`color`,default:[0,0,0,1]}]},so=s({default:()=>co}),co={id:`steel_wool_artisan`,name:`Steel Wool`,category:`Industrial`,description:`Chaos-line noise mimicking tangled metal strands found in industrial abrasives.`,shader:`
    float hash(vec2 p) { return fract(sin(dot(p, vec2(127.1, 311.7))) * 43758.5453); }
    vec4 generate() {
  ...
  `,uniforms:[{id:`u_primary_color`,name:`Steel Strand`,type:`color`,default:[.7,.7,.75,1]},{id:`u_secondary_color`,name:`Internal Shadow`,type:`color`,default:[.1,.1,.15,1]}]},lo=s({default:()=>uo}),uo={id:`stitched_leather_pro`,name:`Stitched Leather`,category:`Organic`,description:`Premium pebbled leather texture with perimeter stitching simulation.`,shader:`
    float hash(vec2 p) { return fract(sin(dot(p, vec2(127.1, 311.7))) * 43758.5453123); }
    vec4 generate() {
      vec2 uv = v_uv * u_scale;
      vec2 gv = fract(uv) - 0.5;
  ...
  `,uniforms:[{id:`u_primary_color`,name:`Pattern Edge`,type:`color`,default:[0,.8,1,1]},{id:`u_secondary_color`,name:`Deep Core`,type:`color`,default:[0,.1,.15,1]}]},mo=s({default:()=>ho}),ho={id:`tech_hex_v2_artisan`,name:`Tech Hex v2`,category:`Technology`,description:`Advanced geometric hex-grid with internal subdivided offsets for sci-fi panels.`,shader:`
  ...
  `,uniforms:[{id:`u_scale`,name:`Module Count`,type:`float`,min:2,max:20,default:10},{id:`u_primary_color`,name:`Housing`,type:`color`,default:[0,.8,1,1]},{id:`u_secondary_color`,name:`Frame`,type:`color`,default:[.05,.05,.08,1]}]},go=s({default:()=>_o}),_o={id:`terrazzo_chip_artisan`,name:`Terrazzo Chip`,category:`Industrial`,description:`Scattered irregular stone flakes and marble chips mimicking professional terrazzo flooring.`,shader:`
    float hash(vec2 p) { return fract(sin(dot(p, vec2(127.1, 311.7))) * 43758.5453); }
    vec4 generate() {
      vec2 uv = v_uv * u_scale;
      vec2 i_uv = floor(uv);
  ...
  `,uniforms:[{id:`u_scale`,name:`Chip Density`,type:`float`,min:10,max:100,default:50},{id:`u_secondary_color`,name:`Binding Resin`,type:`color`,default:[.1,.1,.12,1]}]},N=s({default:()=>vo}),vo={id:`terrazzo_stone_artisan`,name:`Terrazzo Stone`,category:`Industrial`,description:`Multi-colored irregular stone chunks embedded in a polished composite base.`,shader:`
    vec2 rand2(vec2 p) { return fract(sin(vec2(dot(p, vec2(127.1, 311.7)), dot(p, vec2(269.5, 183.3)))) * 43758.5453); }
    vec4 generate() {
      vec2 uv = v_uv * u_scale;
      vec2 i_uv = floor(uv);
  ...
  `,uniforms:[{id:`u_scale`,name:`Chip Density`,type:`float`,min:2,max:20,default:8},{id:`u_primary_color`,name:`Stone Chip`,type:`color`,default:[.6,.62,.65,1]},{id:`u_secondary_color`,name:`Base Mortar`,type:`color`,default:[.8,.8,.82,1]}]},yo=s({default:()=>P}),P={id:`threaded_screw_artisan`,name:`Threaded Bolt`,category:`Industrial`,description:`Helical metal grooves representing industrial fasteners and bolts.`,shader:`
    vec4 generate() {
      vec2 uv = v_uv * u_scale;
  ...
  `,uniforms:[{id:`u_scale`,name:`Thread Pitch`,type:`float`,min:1,max:10,default:5},{id:`u_primary_color`,name:`Peak Metal`,type:`color`,default:[.9,.9,.95,1]},{id:`u_secondary_color`,name:`Valley`,type:`color`,default:[.1,.1,.15,1]}]},F=s({default:()=>I}),I={id:`tiger_stripes_artisan`,name:`Predator Stripes`,category:`Organic`,description:`Organic predator-style tiger stripes with tapered edges.`,shader:`
    float hash(vec2 p) { return fract(sin(dot(p, vec2(127.1, 311.7))) * 43758.5453123); }
    float noise(vec2 p) {
      vec2 i = floor(p); vec2 f = fract(p);
      f = f*f*(3.0-2.0*f);
  ...
  `,uniforms:[{id:`u_scale`,name:`Detail Zoom`,type:`float`,min:2,max:20,default:10},{id:`u_primary_color`,name:`Rubber High`,type:`color`,default:[.15,.15,.15,1]},{id:`u_secondary_color`,name:`Rubber Base`,type:`color`,default:[.08,.08,.08,1]}]},wo=s({default:()=>To}),To={id:`tire_tread_rain`,name:`Rain Tire Tread`,category:`Racing`,description:`Deep directional grooves for wet weather conditions.`,shader:`
    vec4 generate() {
      vec2 uv = v_uv * u_scale;
  ...
  `,uniforms:[{id:`u_scale`,name:`Density`,type:`float`,min:2,max:20,default:8},{id:`u_primary_color`,name:`Rubber`,type:`color`,default:[.15,.15,.15,1]},{id:`u_secondary_color`,name:`Groove`,type:`color`,default:[.05,.05,.05,1]}]},Eo=s({default:()=>L}),L={id:`topographic_pro`,name:`Topographic Map`,category:`Abstract`,description:`Technical contour lines mimicking elevation mapping.`,shader:`
    float hash(vec2 p) { return fract(sin(dot(p, vec2(127.1, 311.7))) * 43758.5453123); }
    float noise(vec2 p) {
      vec2 i = floor(p); vec2 f = fract(p);
      f = f*f*(3.0-2.0*f);
  ...
  `,uniforms:[{id:`u_scale`,name:`Territory Size`,type:`float`,min:1,max:10,default:3},{id:`u_layers`,name:`Contour Detail`,type:`float`,min:5,max:50,default:20},{id:`u_primary_color`,name:`Line Color`,type:`color`,default:[1,1,1,1]},{id:`u_secondary_color`,name:`Land Color`,type:`color`,default:[.1,.1,.1,1]}]},Do=s({default:()=>Oo}),Oo={id:`truchet_tiles_artisan`,name:`Truchet Arc`,category:`Abstract`,description:`Interlocking arc-based tiles mimicking complex organic circuitry and decorative pavement.`,shader:`
    float hash(vec2 p) { return fract(sin(dot(p, vec2(127.1, 311.7))) * 43758.5453); }
    vec4 generate() {
      vec2 uv = v_uv * u_scale;
      vec2 i_uv = floor(uv);
  ...
  `,uniforms:[{id:`u_scale`,name:`Tile Zoom`,type:`float`,min:2,max:20,default:10},{id:`u_primary_color`,name:`Arc Ribbon`,type:`color`,default:[1,.4,0,1]},{id:`u_secondary_color`,name:`Tile Depth`,type:`color`,default:[.1,.1,.15,1]}]},ko=s({default:()=>Ao}),Ao={id:`turbo_fan_artisan`,name:`Turbo Turbine`,category:`Technology`,description:`Radial blades of a high-boost turbocharger compressor wheel.`,shader:`
    vec4 generate() {
      vec2 uv = v_uv - 0.5;
      float angle = atan(uv.y, uv.x);
  ...
  `,uniforms:[{id:`u_blades`,name:`Blade Count`,type:`float`,min:6,max:24,default:12},{id:`u_primary_color`,name:`Blade Top`,type:`color`,default:[.9,.92,.95,1]},{id:`u_secondary_color`,name:`Blade Void`,type:`color`,default:[.1,.1,.15,1]}]},jo=s({default:()=>Mo}),Mo={id:`twill_carbon_pro`,name:`Pro Twill Carbon`,category:`Racing`,description:`Classic high-detail 2x2 carbon fiber weave.`,shader:`
    vec4 generate() {
      vec2 uv = v_uv * u_scale;
      vec2 gv = fract(uv);
      vec2 id = floor(uv);
  ...
  `,uniforms:[{id:`u_primary_color`,name:`Sun Core`,type:`color`,default:[1,.6,0,1]},{id:`u_secondary_color`,name:`Atmosphere`,type:`color`,default:[1,0,.5,1]}]},Fo=s({default:()=>R}),R={id:`void_grid_artisan`,name:`Void Grid`,category:`Abstract`,description:`Infinite perspective grid reminiscent of 1980s retro-futuristic digital visualization.`,shader:`
    vec4 generate() {
      vec2 uv = v_uv * u_scale;
      float grid = step(0.95, fract(uv.x)) + step(0.95, fract(uv.y));
      return mix(u_secondary_color, u_primary_color, clamp(grid, 0.0, 1.0));
    }
  `,uniforms:[{id:`u_scale`,name:`Grid Density`,type:`float`,min:5,max:50,default:20},{id:`u_primary_color`,name:`Grid Glow`,type:`color`,default:[1,0,1,1]},{id:`u_secondary_color`,name:`Void Base`,type:`color`,default:[0,0,.05,1]}]},Io=s({default:()=>Lo}),Lo={id:`volcanic_basalt_artisan`,name:`Basalt Pillar`,category:`Geology`,description:`Pitted, geometric volcanic rock found in hexagonal basalt formations.`,shader:`
    vec4 generate() {
      vec2 uv = v_uv * u_scale;
      if (mod(floor(uv.y), 2.0) == 0.0) uv.x += 0.5;
      vec2 gv = fract(uv) - 0.5;
  ...
  `,uniforms:[{id:`u_scale`,name:`Cell Count`,type:`float`,min:2,max:20,default:8},{id:`u_primary_color`,name:`Cell Center`,type:`color`,default:[.2,.2,.25,1]},{id:`u_secondary_color`,name:`Cell Border`,type:`color`,default:[.1,.1,.12,1]}]},Bo=s({default:()=>Vo}),Vo={id:`water_ripples_artisan`,name:`Water Ripples`,category:`Natural`,description:`Static concentric liquid wave interference patterns.`,shader:`
    vec4 generate() {
      vec2 uv = (v_uv - 0.5) * u_scale;
      float d = length(uv);
  ...
  `,uniforms:[{id:`u_scale`,name:`Wave Scale`,type:`float`,min:1,max:10,default:5},{id:`u_primary_color`,name:`Peak Color`,type:`color`,default:[.1,.6,1,1]},{id:`u_secondary_color`,name:`Deep Water`,type:`color`,default:[0,.2,.4,1]}]},Ho=s({default:()=>Uo}),Uo={id:`watercolor_bleed_artisan`,name:`Watercolor Flow`,category:`Abstract`,description:`Soft organic color spreads and bleeding textures mimicking paint on high-fidelity wet paper.`,shader:`
    float hash(vec2 p) { return fract(sin(dot(p, vec2(127.1, 311.7))) * 43758.5453); }
    float noise(vec2 p) {
      vec2 i = floor(p); vec2 f = fract(p);
      f = f*f*(3.0-2.0*f);
  ...
  `,uniforms:[{id:`u_primary_color`,name:`Ink Bleed`,type:`color`,default:[.2,.4,.8,.8]},{id:`u_secondary_color`,name:`Pulp Base`,type:`color`,default:[.95,.95,.9,1]}]},Wo=s({default:()=>Go}),Go={id:`wavy_checkers_artisan`,name:`Wavy Checkers`,category:`Racing`,description:`Flowing, distorted racing flags mimicking a waving checkered banner.`,shader:`
    vec4 generate() {
      vec2 uv = v_uv * u_scale;
  ...
  `,uniforms:[{id:`u_scale`,name:`Chip Detail`,type:`float`,min:5,max:50,default:10},{id:`u_primary_color`,name:`Paint`,type:`color`,default:[.8,.1,.1,1]},{id:`u_secondary_color`,name:`Exposed Metal`,type:`color`,default:[.3,.3,.35,1]}]},Jo=s({default:()=>Yo}),Yo={id:`weathered_rust_pro`,name:`Weathered Rust`,category:`Industrial`,description:`Pro-grade oxidizing metallic surface with realistic pitting and oxidation layers.`,shader:`
    float hash(vec2 p) { return fract(sin(dot(p, vec2(127.1, 311.7))) * 43758.5453123); }
    float noise(vec2 p) {
      vec2 i = floor(p); vec2 f = fract(p);
      f = f*f*(3.0-2.0*f);
  ...
  `,uniforms:[{id:`u_scale`,name:`Rust Intensity`,type:`float`,min:1,max:20,default:5}]},Xo=s({default:()=>Zo}),Zo={id:`wicker_weave_artisan`,name:`Wicker Weave`,category:`Natural`,description:`Interlocking thick strands of woven wood found in traditional basketry.`,shader:`
    vec4 generate() {
      vec2 uv = v_uv * u_scale;
      float w = floor(uv.y);
  ...
  `,uniforms:[{id:`u_scale`,name:`Weave Density`,type:`float`,min:2,max:20,default:8},{id:`u_primary_color`,name:`Wicker Slat`,type:`color`,default:[.7,.5,.3,1]},{id:`u_secondary_color`,name:`Joint Deep`,type:`color`,default:[.2,.1,.05,1]}]},Qo=s({default:()=>$o}),$o={id:`wood_block_print_artisan`,name:`Wood Print`,category:`Abstract`,description:`Coarse carved relief texture mimicking traditional wood block printing techniques.`,shader:`
    float hash(vec2 p) { return fract(sin(dot(p, vec2(127.1, 311.7))) * 43758.5453); }
    vec4 generate() {
  ...
  `,uniforms:[{id:`u_primary_color`,name:`Relief High`,type:`color`,default:[.2,.2,.2,1]},{id:`u_secondary_color`,name:`Carved Wood`,type:`color`,default:[.1,.05,0,1]}]},es=s({default:()=>ts}),ts={id:`wood_grain_artisan`,name:`Wood Grain Pro`,category:`Natural`,description:`High-detail procedural timber with concentric growth rings and knots.`,shader:`
    float hash(vec2 p) { return fract(sin(dot(p, vec2(127.1, 311.7))) * 43758.5453); }
    float noise(vec2 p) {
      vec2 i = floor(p); vec2 f = fract(p);
      f = f*f*(3.0-2.0*f);
  ...
  `,uniforms:[{id:`u_scale`,name:`Wood density`,type:`float`,min:1,max:10,default:4},{id:`u_primary_color`,name:`Grain Color`,type:`color`,default:[.3,.15,.05,1]},{id:`u_secondary_color`,name:`Base Timber`,type:`color`,default:[.45,.25,.1,1]}]},ns=s({default:()=>rs}),rs={id:`wood_parquet_artisan`,name:`Wood Parquet`,category:`Industrial`,description:`Complex interlocking geometric floor planks for premium interior design.`,shader:`
    vec4 generate() {
      vec2 uv = v_uv * u_scale;
      vec2 gv = floor(uv);
      float mask = mod(gv.x + gv.y, 2.0);
  ...
  `,uniforms:[{id:`u_scale`,name:`Pattern Density`,type:`float`,min:1,max:10,default:5},{id:`u_primary_color`,name:`Stripe A`,type:`color`,default:[0,0,0,1]},{id:`u_secondary_color`,name:`Stripe B`,type:`color`,default:[1,1,1,1]}]},os=[`All`,`Racing`,`Geometric`,`Technology`,`Organic`,`Utility`,`Industrial`,`Abstract`,`Natural`],ss=Object.values(Object.assign({"./patterns/acid_etch.js":x,"./patterns/alcantara_suede.js":S,"./patterns/anodized_titanium.js":te,"./patterns/apex_curbing.js":re,"./patterns/argyle_knit.js":ie,"./patterns/asphalt_pro.js":oe,"./patterns/autumn_leaves.js":ce,"./patterns/banded_agate.js":ue,"./patterns/barbed_wire.js":E,"./patterns/bird_plumage.js":fe,"./patterns/blueprint_grid.js":me,"./patterns/bone_pores.js":O,"./patterns/braided_cord.js":ge,"./patterns/brain_coral.js":ve,"./patterns/brake_dust.js":be,"./patterns/brake_rotor_wear.js":Se,"./patterns/brake_rotors.js":we,"./patterns/brick_masonry.js":Ee,"./patterns/brushed_aluminum.js":Oe,"./patterns/burlap_sack.js":Ae,"./patterns/butterfly_wing.js":Me,"./patterns/cactus_needles.js":Pe,"./patterns/canvas_rip.js":Ie,"./patterns/carpet_velour.js":Re,"./patterns/chain_mail.js":Be,"./patterns/chalkboard_dust.js":He,"./patterns/charcoal_sketch.js":We,"./patterns/chopped_carbon.js":Ke,"./patterns/circuit_traces.js":Je,"./patterns/coral_reef.js":Xe,"./patterns/corduroy_rib.js":Qe,"./patterns/corrugated_steel.js":et,"./patterns/crocodile_hide.js":nt,"./patterns/cyber_grid.js":it,"./patterns/cyber_leather.js":ot,"./patterns/cyber_twill.js":ct,"./patterns/cyber_wiring.js":ut,"./patterns/damask_lace.js":ft,"./patterns/damask_silk.js":mt,"./patterns/data_matrix.js":gt,"./patterns/demon_scales.js":vt,"./patterns/denim_weave.js":bt,"./patterns/desert_dunes.js":St,"./patterns/diamond_plate.js":wt,"./patterns/diamond_quilt.js":Et,"./patterns/diamond_stitch_v2.js":Ot,"./patterns/diatom_shells.js":kt,"./patterns/diffraction_grating.js":jt,"./patterns/digi_camo_urban.js":Nt,"./patterns/digital_camo_v2.js":Ft,"./patterns/digital_glitch.js":Lt,"./patterns/door_panel_fabric.js":zt,"./patterns/dragon_plate.js":Vt,"./patterns/energy_shield.js":Ut,"./patterns/etched_brass.js":Gt,"./patterns/exhaust_heat.js":qt,"./patterns/expanded_grating.js":Yt,"./patterns/fiber_optic_bundle.js":Zt,"./patterns/fingerprint_swirls.js":$t,"./patterns/fish_scales.js":tn,"./patterns/fluid_marbling.js":rn,"./patterns/forest_litter.js":on,"./patterns/forged_carbon.js":cn,"./patterns/frost_crystals.js":un,"./patterns/frozen_lake.js":fn,"./patterns/fusion_panel.js":mn,"./patterns/galvanized_steel.js":gn,"./patterns/gauge_cluster.js":vn,"./patterns/geometric_fracture.js":bn,"./patterns/glacier_ice.js":Sn,"./patterns/glass_shards.js":wn,"./patterns/glitch_interference.js":En,"./patterns/glitch_text_logic.js":On,"./patterns/gold_leaf.js":An,"./patterns/gold_leaf_flake.js":Mn,"./patterns/gothic_filigree.js":Pn,"./patterns/gravel_trap.js":In,"./patterns/greek_key.js":Rn,"./patterns/halftone_dots.js":Bn,"./patterns/halftone_pop.js":Hn,"./patterns/hammered_copper.js":Wn,"./patterns/harlequin_diamond.js":Kn,"./patterns/headliner_mesh.js":Jn,"./patterns/herringbone.js":Xn,"./patterns/hex_mesh.js":Qn,"./patterns/holographic_glitch.js":er,"./patterns/honeycomb_bio.js":nr,"./patterns/houndstooth.js":ir,"./patterns/hunting_camo.js":or,"./patterns/impasto_paint.js":cr,"./patterns/infinite_spiral.js":ur,"./patterns/ink_blot_test.js":fr,"./patterns/iris_fibers.js":mr,"./patterns/julia_fractal.js":gr,"./patterns/kevlar_grid.js":vr,"./patterns/lava_crust.js":br,"./patterns/leaf_skeleton.js":Sr,"./patterns/lichen_growth.js":wr,"./patterns/lichtenberg_trees.js":Er,"./patterns/linear_gradient.js":Or,"./patterns/liquid_mercury.js":Ar,"./patterns/louis_check.js":Mr,"./patterns/macrame_knot.js":Pr,"./patterns/mandala_radial.js":Ir,"./patterns/mandelbrot_fractal.js":Rr,"./patterns/maple_leaves.js":Br,"./patterns/marble_stone.js":Hr,"./patterns/micro_cells.js":Wr,"./patterns/micro_logic_grid.js":Kr,"./patterns/microchip_wafer.js":Jr,"./patterns/moire_silk.js":Xr,"./patterns/monstera_leaf.js":Qr,"./patterns/mother_of_pearl.js":ei,"./patterns/mud_cracks.js":ni,"./patterns/mushroom_gills.js":ii,"./patterns/nanotech_cells.js":oi,"./patterns/nappa_leather.js":ci,"./patterns/nebula_dust.js":ui,"./patterns/neon_tubes.js":fi,"./patterns/neural_net.js":mi,"./patterns/obsidian_fracture.js":gi,"./patterns/oil_canvas.js":vi,"./patterns/olive_branch.js":bi,"./patterns/palm_fronds.js":Si,"./patterns/paper_tear.js":wi,"./patterns/pcb_traces_v3.js":Ei,"./patterns/peacock_eyes.js":Oi,"./patterns/peat_moss.js":Ai,"./patterns/penrose_tiling.js":Mi,"./patterns/petrified_wood.js":Pi,"./patterns/pine_bark.js":Ii,"./patterns/piston_top.js":Ri,"./patterns/pixel_art_canvas.js":Bi,"./patterns/plaid_tartan.js":Hi,"./patterns/plant_cells.js":j,"./patterns/plasma_core.js":Wi,"./patterns/polka_dot.js":Ki,"./patterns/prism_shards.js":Ji,"./patterns/pulsar_radial.js":Xi,"./patterns/quantum_foam.js":Qi,"./patterns/quartz_crystal.js":ea,"./patterns/radial_gradient.js":na,"./patterns/reaction_diffusion.js":ia,"./patterns/realistic_viper.js":oa,"./patterns/rim_spoke_carbon.js":ca,"./patterns/river_cobble.js":ua,"./patterns/river_stone.js":fa,"./patterns/rivet_lines.js":ma,"./patterns/rivet_plate_elite.js":ha,"./patterns/roll_cage_foam.js":_a,"./patterns/roof_shingles.js":ya,"./patterns/root_system.js":xa,"./patterns/safety_harness.js":Ca,"./patterns/sand_dunes.js":Ta,"./patterns/sandstone_layers.js":Da,"./patterns/seat_perforation.js":ka,"./patterns/server_rack_mesh.js":ja,"./patterns/shift_boot_leather.js":Na,"./patterns/sierpinski_carpet.js":Fa,"./patterns/sierpinski_mesh.js":La,"./patterns/skeletal_mesh.js":za,"./patterns/snake_skin.js":Va,"./patterns/snake_skin_v2.js":Ua,"./patterns/solar_flare.js":Ga,"./patterns/solar_flares_v2.js":qa,"./patterns/speed_trails.js":Ya,"./patterns/spider_web.js":Za,"./patterns/spray_drip.js":$a,"./patterns/stained_glass.js":to,"./patterns/star_field.js":ro,"./patterns/starlight_drive.js":ao,"./patterns/steel_wool.js":so,"./patterns/stitched_leather.js":lo,"./patterns/tech_fractal.js":fo,"./patterns/tech_hex_v2.js":mo,"./patterns/terrazzo_chip.js":go,"./patterns/terrazzo_stone.js":N,"./patterns/threaded_screw.js":yo,"./patterns/tiger_stripes.js":F,"./patterns/tire_marbles.js":bo,"./patterns/tire_sidewall.js":So,"./patterns/tire_tread_rain.js":wo,"./patterns/topo_map.js":Eo,"./patterns/truchet_tiles.js":Do,"./patterns/turbo_fan.js":ko,"./patterns/twill_carbon.js":jo,"./patterns/vaporwave_sun.js":No,"./patterns/void_grid.js":Fo,"./patterns/volcanic_basalt.js":Io,"./patterns/voronoi_cells.js":Ro,"./patterns/water_ripples.js":Bo,"./patterns/watercolor_bleed.js":Ho,"./patterns/wavy_checkers.js":Wo,"./patterns/weathered_paint.js":Ko,"./patterns/weathered_rust.js":Jo,"./patterns/wicker_weave.js":Xo,"./patterns/wood_block_print.js":Qo,"./patterns/wood_grain_pro.js":es,"./patterns/wood_parquet.js":ns,"./patterns/zebra_camo_v2.js":is})).map(e=>e.default),cs=(...e)=>e.filter((e,t,n)=>!!e&&e.trim()!==``&&n.indexOf(e)===t).join(` `).trim(),ls=e=>e.replace(/([a-z0-9])([A-Z])/g,`$1-$2`).toLowerCase(),us=e=>e.replace(/^([A-Z])|[\s-_]+(\w)/g,(e,t,n)=>n?n.toUpperCase():t.toLowerCase()),ds=e=>{let t=us(e);return t.charAt(0).toUpperCase()+t.slice(1)},fs={xmlns:`http://www.w3.org/2000/svg`,width:24,height:24,viewBox:`0 0 24 24`,fill:`none`,stroke:`currentColor`,strokeWidth:2,strokeLinecap:`round`,strokeLinejoin:`round`},ps=e=>{for(let t in e)if(t.startsWith(`aria-`)||t===`role`||t===`title`)return!0;return!1},ms=(0,v.createContext)({}),hs=()=>(0,v.useContext)(ms),gs=(0,v.forwardRef)(({color:e,size:t,strokeWidth:n,absoluteStrokeWidth:r,className:i=``,children:a,iconNode:o,...s},c)=>{let{size:l=24,strokeWidth:u=2,absoluteStrokeWidth:d=!1,color:f=`currentColor`,className:p=``}=hs()??{},m=r??d?Number(n??u)*24/Number(t??l):n??u;return(0,v.createElement)(`svg`,{ref:c,...fs,width:t??l??fs.width,height:t??l??fs.height,stroke:e??f,strokeWidth:m,className:cs(`lucide`,p,i),...!a&&!ps(s)&&{"aria-hidden":`true`},...s},[...o.map(([e,t])=>(0,v.createElement)(e,t)),...Array.isArray(a)?a:[a]])}),_s=(e,t)=>{let n=(0,v.forwardRef)(({className:n,...r},i)=>(0,v.createElement)(gs,{ref:i,iconNode:t,className:cs(`lucide-${ls(ds(e))}`,`lucide-${e}`,n),...r}));return n.displayName=ds(e),n},vs=_s(`download`,[[`path`,{d:`M12 15V3`,key:`m9g1x1`}],[`path`,{d:`M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4`,key:`ih7n3h`}],[`path`,{d:`m7 10 5 5 5-5`,key:`brsn70`}]]),ys=_s(`info`,[[`circle`,{cx:`12`,cy:`12`,r:`10`,key:`1mglay`}],[`path`,{d:`M12 16v-4`,key:`1dtifu`}],[`path`,{d:`M12 8h.01`,key:`e9boi3`}]]),bs=_s(`layers`,[[`path`,{d:`M12.83 2.18a2 2 0 0 0-1.66 0L2.6 6.08a1 1 0 0 0 0 1.83l8.58 3.91a2 2 0 0 0 1.66 0l8.58-3.9a1 1 0 0 0 0-1.83z`,key:`zw3jo`}],[`path`,{d:`M2 12a1 1 0 0 0 .58.91l8.6 3.91a2 2 0 0 0 1.65 0l8.58-3.9A1 1 0 0 0 22 12`,key:`1wduqc`}],[`path`,{d:`M2 17a1 1 0 0 0 .58.91l8.6 3.91a2 2 0 0 0 1.65 0l8.58-3.9A1 1 0 0 0 22 17`,key:`kqbvx6`}]]),xs=_s(`maximize`,[[`path`,{d:`M8 3H5a2 2 0 0 0-2 2v3`,key:`1dcmit`}],[`path`,{d:`M21 8V5a2 2 0 0 0-2-2h-3`,key:`1e4gt3`}],[`path`,{d:`M3 16v3a2 2 0 0 0 2 2h3`,key:`wsl5sc`}],[`path`,{d:`M16 21h3a2 2 0 0 0 2-2v-3`,key:`18trek`}]]),Ss=_s(`search`,[[`path`,{d:`m21 21-4.34-4.34`,key:`14j7rj`}],[`circle`,{cx:`11`,cy:`11`,r:`8`,key:`4ej97u`}]]),Cs=_s(`settings`,[[`path`,{d:`M9.671 4.136a2.34 2.34 0 0 1 4.659 0 2.34 2.34 0 0 0 3.319 1.915 2.34 2.34 0 0 1 2.33 4.033 2.34 2.34 0 0 0 0 3.831 2.34 2.34 0 0 1-2.33 4.033 2.34 2.34 0 0 0-3.319 1.915 2.34 2.34 0 0 1-4.659 0 2.34 2.34 0 0 0-3.32-1.915 2.34 2.34 0 0 1-2.33-4.033 2.34 2.34 0 0 0 0-3.831A2.34 2.34 0 0 1 6.35 6.051a2.34 2.34 0 0 0 3.319-1.915`,key:`1i5ecw`}],[`circle`,{cx:`12`,cy:`12`,r:`3`,key:`1v7zrd`}]]),ws=_s(`shield`,[[`path`,{d:`M20 13c0 5-3.5 7.5-7.66 8.95a1 1 0 0 1-.67-.01C7.5 20.5 4 18 4 13V6a1 1 0 0 1 1-1c2 0 4.5-1.2 6.24-2.72a1.17 1.17 0 0 1 1.52 0C14.51 3.81 17 5 19 5a1 1 0 0 1 1 1z`,key:`oel41y`}]]),Ts=_s(`x`,[[`path`,{d:`M18 6 6 18`,key:`1bl5f8`}],[`path`,{d:`m6 6 12 12`,key:`d8bk6v`}]]),Es=_s(`zap`,[[`path`,{d:`M4 14a1 1 0 0 1-.78-1.63l9.9-10.2a.5.5 0 0 1 .86.46l-1.92 6.02A1 1 0 0 0 13 10h7a1 1 0 0 1 .78 1.63l-9.9 10.2a.5.5 0 0 1-.86-.46l1.92-6.02A1 1 0 0 0 11 14z`,key:`1xq2db`}]]),Ds=o((e=>{var t=Symbol.for(`react.transitional.element`);function n(e,n,r){var i=null;if(r!==void 0&&(i=``+r),n.key!==void 0&&(i=``+n.key),`key`in n)for(var a in r={},n)a!==`key`&&(r[a]=n[a]);else r=n;return n=r.ref,{$$typeof:t,type:e,key:i,ref:n===void 0?null:n,props:r}}e.jsx=n,e.jsxs=n})),z=o(((e,t)=>{t.exports=Ds()}))();function Os(){let e=(0,v.useRef)(null),t=(0,v.useRef)(null),[n,r]=(0,v.useState)(ss[0]),[i,a]=(0,v.useState)({}),[o,s]=(0,v.useState)(!1),[c,l]=(0,v.useState)(2048),[u,d]=(0,v.useState)(!0),f=window.electronAPI!==void 0,[p,m]=(0,v.useState)(``),[h,g]=(0,v.useState)(`All`),[_,y]=(0,v.useState)(``),[x,ee]=(0,v.useState)(!1),[S,C]=(0,v.useState)(!1),[te,ne]=(0,v.useState)(null),[re,w]=(0,v.useState)([]),[ie,ae]=(0,v.useState)(1),oe=(0,v.useMemo)(()=>ss.filter(e=>{let t=e.name.toLowerCase().includes(p.toLowerCase())||e.description.toLowerCase().includes(p.toLowerCase()),n=h===`All`||e.category===h;return t&&n}),[p,h]);(0,v.useEffect)(()=>{if(!e.current)return;let r=new b(e.current);return t.current=r,se(n),()=>r.stop()},[e]),(0,v.useEffect)(()=>{let n=()=>{if(!t.current||!e.current)return;let n=u?340:0;e.current.width=window.innerWidth-n-40,e.current.height=window.innerHeight-100};return window.addEventListener(`resize`,n),n(),()=>window.removeEventListener(`resize`,n)},[u]),(0,v.useEffect)(()=>{window.electronAPI&&(window.electronAPI.onUpdateStatus(e=>{y(e),w(t=>[...t.slice(-4),e])}),window.electronAPI.onUpdateAvailableData(e=>{ee(!0),ne(e),w(t=>[...t.slice(-4),`v${e.version} found on GitHub`])}),window.electronAPI.onUpdateDownloaded(()=>{C(!0),ee(!1),w(e=>[...e.slice(-4),`Update ready — click to install`])}))},[]),(0,v.useEffect)(()=>{t.current&&t.current.render({u_opacity:ie})},[ie]);let se=async e=>{if(!t.current)return;let n={};e.uniforms.forEach(e=>{n[e.id]=e.default}),a(n),await t.current.setShader(e),t.current.render({...n,u_is_spec:+!!o})},ce=e=>{r(e),se(e)},le=(e,n)=>{let r={...i,[e]:n};a(r),t.current&&t.current.render({...r,u_is_spec:+!!o})};(0,v.useEffect)(()=>{t.current&&t.current.render({u_is_spec:+!!o})},[o]);let ue=()=>{if(!t.current)return;let e=t.current.export(c,c,{...i,u_is_spec:+!!o}),r=document.createElement(`a`);r.download=`simtex_${n.id}_${o?`spec`:`diff`}_${c}.png`,r.href=e,r.click()},T=e=>{let t=e=>Math.round(e*255).toString(16).padStart(2,`0`);return`#${t(e[0])}${t(e[1])}${t(e[2])}`},E=(e,t=1)=>[parseInt(e.slice(1,3),16)/255,parseInt(e.slice(3,5),16)/255,parseInt(e.slice(5,7),16)/255,t];return(0,z.jsxs)(`div`,{className:`app-container`,children:[(0,z.jsxs)(`aside`,{className:`sidebar glass-panel ${u?`open`:`closed`}`,children:[(0,z.jsxs)(`div`,{className:`sidebar-top`,children:[(0,z.jsx)(`div`,{className:`sidebar-header`,children:(0,z.jsxs)(`div`,{className:`logo`,children:[(0,z.jsx)(ws,{size:24,color:`var(--color-accent)`}),(0,z.jsxs)(`h1`,{children:[`SIMTEX`,(0,z.jsx)(`span`,{children:`PRO`}),` `,(0,z.jsx)(`small`,{className:`v-tag`,children:`v3.0.0`})]})]})}),(0,z.jsxs)(`section`,{className:`sidebar-section`,children:[(0,z.jsxs)(`div`,{className:`search-wrapper`,children:[(0,z.jsx)(Ss,{size:16,className:`search-icon`}),(0,z.jsx)(`input`,{type:`text`,placeholder:`Search patterns...`,value:p,onChange:e=>m(e.target.value),className:`search-input`}),p&&(0,z.jsx)(Ts,{size:14,className:`clear-search`,onClick:()=>m(``)})]}),(0,z.jsx)(`div`,{className:`category-tabs pro-scrollbar`,children:os.map(e=>(0,z.jsx)(`button`,{className:`category-tab ${h===e?`active`:``}`,onClick:()=>g(e),children:e},e))})]})]}),(0,z.jsxs)(`section`,{className:`patterns-container pro-scrollbar`,children:[(0,z.jsxs)(`div`,{className:`section-title`,children:[(0,z.jsx)(bs,{size:16}),(0,z.jsxs)(`span`,{children:[`PATTERNS (`,oe.length,`)`]})]}),(0,z.jsx)(`div`,{className:`pattern-grid`,children:oe.length>0?oe.map(e=>(0,z.jsxs)(`button`,{className:`pattern-card ${n.id===e.id?`active`:``}`,onClick:()=>ce(e),children:[(0,z.jsxs)(`div`,{className:`card-header`,children:[(0,z.jsx)(`div`,{className:`pattern-name`,children:e.name}),(0,z.jsx)(`div`,{className:`pattern-category`,children:e.category})]}),(0,z.jsx)(`div`,{className:`pattern-desc`,children:e.description})]},e.id)):(0,z.jsxs)(`div`,{className:`no-results`,children:[`No patterns found for "`,p,`"`]})})]}),(0,z.jsxs)(`div`,{className:`sidebar-bottom`,children:[(0,z.jsxs)(`section`,{className:`sidebar-section`,children:[(0,z.jsxs)(`div`,{className:`section-title`,children:[(0,z.jsx)(Cs,{size:16}),(0,z.jsx)(`span`,{children:`CONTROLS`})]}),(0,z.jsxs)(`div`,{className:`controls-list pro-scrollbar`,children:[(0,z.jsxs)(`div`,{className:`control-group master-control`,children:[(0,z.jsxs)(`div`,{className:`control-label`,children:[(0,z.jsx)(`span`,{children:`Master Opacity`}),(0,z.jsxs)(`span`,{className:`control-value`,children:[(ie*100).toFixed(0),`%`]})]}),(0,z.jsx)(`input`,{type:`range`,min:`0`,max:`1`,step:`0.01`,value:ie,onChange:e=>ae(parseFloat(e.target.value))})]}),n.uniforms.map(e=>(0,z.jsxs)(`div`,{className:`control-group`,children:[(0,z.jsxs)(`div`,{className:`control-label`,children:[(0,z.jsx)(`span`,{children:e.name}),(0,z.jsx)(`span`,{className:`control-value`,children:e.type===`color`?``:(i[e.id]||0).toFixed(2)})]}),e.type===`float`?(0,z.jsx)(`input`,{type:`range`,min:e.min,max:e.max,step:(e.max-e.min)/100,value:i[e.id]||e.default,onChange:t=>le(e.id,parseFloat(t.target.value))}):(0,z.jsxs)(`div`,{className:`color-control-stack`,children:[(0,z.jsx)(`input`,{type:`color`,className:`color-input`,value:i[e.id]?T(i[e.id]):`#ffffff`,onChange:t=>le(e.id,E(t.target.value,i[e.id]?i[e.id][3]:1))}),(0,z.jsxs)(`div`,{className:`alpha-slider-row`,children:[(0,z.jsx)(`span`,{className:`alpha-label`,children:`Alpha`}),(0,z.jsx)(`input`,{type:`range`,min:`0`,max:`1`,step:`0.01`,value:i[e.id]?i[e.id][3]:1,onChange:t=>{let n=i[e.id]||[1,1,1,1];le(e.id,[n[0],n[1],n[2],parseFloat(t.target.value)])}})]})]})]},e.id))]})]}),(0,z.jsxs)(`section`,{className:`sidebar-section`,children:[(0,z.jsxs)(`div`,{className:`section-title`,children:[(0,z.jsx)(Es,{size:16}),(0,z.jsx)(`span`,{children:`MATERIAL MODE`})]}),(0,z.jsxs)(`div`,{className:`mode-toggle`,children:[(0,z.jsx)(`button`,{className:`toggle-btn ${o?``:`active`}`,onClick:()=>s(!1),children:`Standard`}),(0,z.jsx)(`button`,{className:`toggle-btn ${o?`active`:``}`,onClick:()=>s(!0),children:`iRacing Spec`})]}),o&&(0,z.jsxs)(`div`,{className:`info-box`,children:[(0,z.jsx)(ys,{size:14}),(0,z.jsx)(`p`,{children:`R: Metallic | G: Roughness`})]})]}),re.length>0&&(0,z.jsxs)(`div`,{className:`update-console`,children:[re.map((e,t)=>(0,z.jsx)(`div`,{className:`log-entry`,children:e},t)),x&&(0,z.jsxs)(`button`,{className:`btn-update-action download`,onClick:()=>window.electronAPI.downloadUpdate(),children:[`Download v`,te?.version]}),S&&(0,z.jsx)(`button`,{className:`btn-update-action install`,onClick:()=>window.electronAPI.restartAndInstall(),children:`Install & Restart`})]})]}),(0,z.jsxs)(`div`,{className:`sidebar-footer`,children:[(0,z.jsx)(`span`,{className:`version-label`,children:`v3.0.0`}),f&&(0,z.jsx)(`button`,{className:`check-updates-link`,onClick:()=>window.electronAPI?.checkForUpdates(),children:`Check for Updates`})]})]}),(0,z.jsxs)(`main`,{className:`main-content`,children:[(0,z.jsxs)(`header`,{className:`top-bar glass-panel`,children:[(0,z.jsx)(`div`,{className:`res-selector`,children:[1024,2048,4096].map(e=>(0,z.jsxs)(`button`,{onClick:()=>l(e),className:c===e?`active`:``,children:[e/1024,`K`]},e))}),(0,z.jsxs)(`div`,{className:`actions`,children:[(0,z.jsx)(`button`,{className:`btn-secondary`,onClick:()=>d(!u),children:(0,z.jsx)(xs,{size:18})}),(0,z.jsxs)(`button`,{className:`btn-primary`,onClick:ue,children:[(0,z.jsx)(vs,{size:18}),(0,z.jsx)(`span`,{children:`Export PNG`})]})]})]}),(0,z.jsx)(`div`,{className:`viewport`,children:(0,z.jsxs)(`div`,{className:`canvas-wrapper`,children:[(0,z.jsx)(`canvas`,{ref:e}),(0,z.jsx)(`div`,{className:`canvas-overlay`,children:(0,z.jsxs)(`span`,{children:[c,` x `,c,` PREVIEW`]})})]})})]}),(0,z.jsx)(`style`,{children:`
      ...
      `})]})}(0,y.createRoot)(document.getElementById(`root`)).render((0,z.jsx)(v.StrictMode,{children:(0,z.jsx)(Os,{})}));